    ...
    <div class='container'>
      ...
      <form class="row" enctype="multipart/form-data" action="<?php echo CONTROLLER; ?>/ODRequestController.php" method="POST">
        ...
        <div class='col-md-3 form-group'>
          ...
          <input type='date' name='OdRequestDate' required="" class="form-control form-control-sm" value='<?php echo $Data->OdRequestDate; ?>'>
        </div>

        <div class='col-md-2 col-6 col-xs-6 form-group'>
          <label>From Time</label>
          <input type='time' name='OdPermissionTimeFrom' required="" class="form-control form-control-sm" value='<?php echo $Data->OdPermissionTimeFrom; ?>'>
        </div>

        <div class='col-md-2 col-6 col-xs-6 form-group'>
          <label>To Time</label>
          <input type='time' name='OdPermissionTimeTo' required="" class="form-control form-control-sm" value='<?php echo $Data->OdPermissionTimeTo; ?>'>
        </div>
        ...
        <div class='col-md-8 form-group'>
          ...
          <input type='text' name='OdLocationDetails' class="form-control form-control-sm" value='<?php echo $Data->OdLocationDetails; ?>'>
        </div>
        <?php
        ...
        ?>
          <div class="col-md-4 form-group">
            ...
            <select name='ODFormStatus' class="form-control form-control-sm" required="">
