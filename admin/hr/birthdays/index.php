                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    if (isset($_GET['UserDateOfBirth'])) {
                      ...
                      $AllCustomers = FETCH_DB_TABLE("SELECT * FROM users where UserStatus='1' and MONTH(UserDateOfBirth)='$UserDateOfBirth' ORDER BY DATE(UserDateOfBirth) Desc", true);
                    } else {
                        ...
                        <div class="col-md-12">
                          <div class="p-1 mb-1 shadow-sm rounded-2 bg-white data-list">
                            <p class="mb-0 flex-s-b">
                              ...
                              <span class="w-pr-20">
                                <a href="../../users/details/?uid=<?php echo SECURE(FETCH("SELECT * FROM users where UserId='$UserMainUserId'", "UserId"), "e"); ?>" class="text-primary bold">
                              ...
                              <span class="w-pr-15">
                                <i class="fa fa-cake text-danger"></i> <?php echo DATE_FORMATE("d M, Y", $Customers->UserDateOfBirth); ?>
                              </span>
                              <span class="w-pr-10">
                                <i class="fa fa-cake text-danger"></i> <?php echo DATE_FORMATE("d M", $Customers->UserDateOfBirth); ?>
                              </span>
                            </p>
                          </div>
                        </div>
