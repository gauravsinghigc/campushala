...
if (isset($_POST['CompleteRegistration'])) {
    ...
    $RegUnitSizeApplied = $_SESSION['RegUnitSizeApplied'] . " " . $_SESSION['RegUnitType'];
    ...
    $RegUnitAlloted = $_SESSION['RegUnitAlloted'];
    ...
    if ($PLC_CHARGES_TYPE == "PERCENTAGE") {
        ...
        $PLC_CHARGE_AMOUNT = round($RegUnitCost / 100 * $PLC_CHARGE_VALUE, 2);
    } else {
        $PLC_CHARGE_AMOUNT = $PLC_CHARGE_VALUE;
        $PLC_CHARGE_PER_VALUE = round($PLC_CHARGE_VALUE / $RegUnitCost * 100, 2);
    }
    ...
    $Check = CHECK("SELECT * FROM registrations where RegMainCustomerId='$RegMainCustomerId' and RegProjectId='$RegProjectId' and RegAcknowledgeCode='$RegAcknowledgeCode'");
    if ($Check == null) {
        ...
        if ($RegPayMode == "CASH") {
            ...
            $PaymentActivityRecord = [
                ...
                "RegPayPreviousDetails" => SECURE($ChequePayments, "e"),
                "RegPayRecordUpdatedBy" => LOGIN_UserId,
            ...
            $PaymentActivityRecord = [
                ...
                "RegPayPreviousDetails" => SECURE($WalletPayments, "e"),
                "RegPayRecordUpdatedBy" => LOGIN_UserId,
        ...
        if ($_FILES['CUSTOMER_PHOTO']['name'] != null) {
            $Documents = [
                ...
                "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "PHOTO", "for_UID$CustomerId", "CUSTOMER_PHOTO"),
        ...
        if ($_POST['CUSTOMER_PAN_CARD_NO'] != null) {
            $Documents = [
                ...
                "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "PANCARD", "for_UID$CustomerId", "CUSTOMER_PAN_CARD_FILE"),
                "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
            ];
            INSERT("customer_documents", $Documents);
        }
        ...
        if ($_POST['CUSTOMER_ADHAAR_CARD_NO'] != null) {
            $Documents = [
                ...
                "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "CUSTOMER_ADHAAR_CARD_FILE", "for_UID$CustomerId", "CUSTOMER_ADHAAR_CARD_FILE"),
                "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
            ];
            INSERT("customer_documents", $Documents);
        }
        ...
        if ($_POST['REG_DOC_NAME_1'] != null) {
            $RegDocs = [
                ...
                "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "BOOKING_DOC_", $_POST['REG_DOC_NAME_1'], "REG_DOC_NAME_1_FILE"),
                "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
        ...
        if ($Response == true) {
            $access_url = ADMIN_URL . "/crm/bookings/";
        }
    ...
    $registrations = [
        ...
        "RegUnitAlloted" => $_POST['RegUnitAlloted'] . " " . $_POST['RegUnitType'],
    ...
    if ($PLC_CHARGES_TYPE == "PERCENTAGE") {
        $PLC_CHARGE_PER_VALUE = $PLC_CHARGE_VALUE;
        $PLC_CHARGE_AMOUNT = round((int)$RegUnitCost / 100 * (int)$PLC_CHARGE_VALUE, 2);
    } else {
        $PLC_CHARGE_AMOUNT = $PLC_CHARGE_VALUE;
        $PLC_CHARGE_PER_VALUE = round((int)$PLC_CHARGE_VALUE / (int)$RegUnitCost * 100, 2);
    }
