                  ...
                  <div class="row">
                    <div class="col-md-4">
                      ...
                      <p class="data-list">
                        ...
                        <span><?php echo DATE_FORMATE("d M, Y h:i a", FETCH($ProjectSql, "ProjectCreatedAt")); ?></span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Updated At</span><br>
                        <span><?php echo DATE_FORMATE("d M, Y h:i a", FETCH($ProjectSql, "ProjectUpdatedAt")); ?></span>
                      </p>
                      <p class="data-list">
