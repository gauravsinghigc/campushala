...
include "../../leads/sections/pageHeader.php";
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7 col-12 text-right">
                      <?php if (LOGIN_UserType == "Admin") { ?>
                        <a href="upload.php" class="btn btn-sm btn-dark m-1"><i class="fa fa-upload"></i> Upload Bulk Leads</a>
                      <?php } ?>
                      <?php
                      ...
                      if ($CheckReportingManagersStatus != NULL) { ?>
                        <a href="uploaded-LeadsController.php" class="btn btn-sm btn-dark m-1">Uploaded Leads</a>
                        <a href="send.php" class="btn btn-sm btn-dark m-1">Move Leads <i class="fa fa-exchange"></i></a>
                      <?php } ?>
