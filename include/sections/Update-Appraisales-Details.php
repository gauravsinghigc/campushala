<section class="pop-section hidden" id="update_<?php echo $Reward->UserAppraisalId; ?>">
  <div class="action-window">
    <div class='container'>
      ...
      <form class="row" action="<?php echo CONTROLLER; ?>/AppraisalController.php" method="POST">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-5">
              ...
              <input type="search" name="search" id="search_<?php echo $Reward->UserAppraisalId; ?>" oninput="SearchData('search_<?php echo $Reward->UserAppraisalId; ?>', 'record-data-<?php echo $Reward->UserAppraisalId; ?>')" class='form-control form-control-sm' placeholder="Search Team Member">
              <div class='data-display height-limit'>
                <?php
                $AllUsers = FETCH_DB_TABLE("SELECT UserId, UserFullName, UserPhoneNumber, UserEmailId FROM users where UserStatus='1' and UserId='" . $Reward->UserAppraisalMainUserId . "' ORDER BY UserFullName ASC", true);
                if ($AllUsers == null) {
            ...
            <div class="col-md-7">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" required name="UserAppraisalName" value='<?php echo $Reward->UserAppraisalName; ?>' class="form-control-sm form-control">
                </div>
                <div class="form-group col-md-6">
                  <label>Appraisal Date</label>
                  <input type="date" value="<?php echo $Reward->UserAppraisalDate; ?>" required name="UserAppraisalDate" class="form-control-sm form-control">
                </div>
