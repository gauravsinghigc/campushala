...
{
    if ($paymode == "CASH") {
        echo "<span class='bold text-success'><i class='bi bi-cash'></i> $paymode</span>";
    } elseif ($paymode == "ONLINE_TRANSFER") {
        echo "<span class='bold text-primary'><i class='fa fa-globe'></i> ONLINE</span>";
    } elseif ($paymode == "WALLET_UPI") {
        echo "<span class='bold text-warning'><i class='bi bi-phone'></i> WALLET_UPI</span>";
    } elseif ($paymode == "CHEQUE_DD") {
        echo "<span class='bold text-danger'><i class='bi bi-credit-card-2-front'></i> $paymode</span>";
    } else {
        echo "<span class='bold text-black'><i class='fa fa-check-circle'></i> $paymode</span>";
    }
}
