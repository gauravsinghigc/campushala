<section class="pop-section hidden" id="edit_<?php echo $Req->PolicyId; ?>">
 <div class="action-window">
  <div class='container'>
   ...
   <form class="row" action="<?php echo CONTROLLER; ?>/PolicyController.php" method="POST">
    <?php FormPrimaryInputs(true, [
     "PolicyId" => $Req->PolicyId
    ]); ?>
    <div class='col-md-8 form-group'>
     <label>Policy Name <?php echo $req; ?></label>
     <input type="text" value="<?php echo $Req->PolicyName; ?>" name="PolicyName" class="form-control form-control-sm" required="">
    </div>
    <div class='col-md-4 form-group'>
     <label>Active From <?php echo $req; ?></label>
     <input type="date" value="<?php echo $Req->PolicyActiveFrom; ?>" name="PolicyActiveFrom" class="form-control form-control-sm" required="">
    </div>
