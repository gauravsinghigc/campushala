        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-5">
              ...
              <input type="search" name="search" id="search" oninput="SearchData('search', 'record-data')" class='form-control form-control-sm' placeholder="Search Team Member">
              <div class='data-display height-limit'>
                <?php
                $AllUsers = FETCH_DB_TABLE("SELECT UserId, UserFullName, UserPhoneNumber, UserEmailId FROM users where UserStatus='1' ORDER BY UserFullName ASC", true);
                if ($AllUsers == null) {
            ...
            <div class="col-md-7">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" required name="RewardName" class="form-control-sm form-control">
                </div>
                <div class="form-group col-md-6">
                  <label>Reward Receive Date</label>
                  <input type="date" value="<?php echo date('Y-m-d'); ?>" required name="RewardReceiveDate" class="form-control-sm form-control">
                </div>
