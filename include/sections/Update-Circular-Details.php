<section class="pop-section hidden" id="update_details_<?php echo $Record->CircularId; ?>">
  <div class="action-window">
    <div class='container'>
      ...
      <form class="row" action="<?php echo CONTROLLER; ?>/CircularController.php" method="POST">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <input type="text" required name="CircularName" value='<?php echo $Record->CircularName; ?>' class="form-control-sm form-control">
            </div>
            <div class="form-group col-md-6">
              <label>Mail Subject</label>
              <input type="text" required value='<?php echo $Record->CircularSubject; ?>' name="CircularSubject" class="form-control-sm form-control">
            </div>
            <div class="form-group col-md-6">
              <label>Circular Date</label>
              <input type="date" value="<?php echo $Record->CircularDate; ?>" required name="CircularDate" class="form-control-sm form-control">
            </div>
            <div class="form-group col-md-6">
              <label>Mail Status</label>
              <select class="form-control form-control-sm" name='MailSent' required>
                <?php echo InputOptionWithKeys([
