...
if (isset($_GET['ProjectName'])) {
  $ProjecName = $_GET['ProjectName'];
  UPDATE("UPDATE lead_requirements SET LeadRequirementDetails='$ProjecName' where LeadMainId='$REQ_LeadsId'");
}
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="card card-primary">
                <div class="card-body">
                  <div class="row">
                    ...
                    <?php } ?>
                    <div class="col-md-12">
                      <h4 class="app-heading"><b class='text-white'>All Leads | </b><?php echo $PageName; ?> <small class="text-white"><?php echo LEADID($REQ_LeadsId); ?></small></h4>
                    </div>
                        ...
                        <div class="row mt-2">
                          <div class="col-md-6">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="flex-s-b">
                                  <a href="whatsapp://send?phone=91<?php echo FETCH($PageSqls, "LeadPersonPhoneNumber"); ?>&text=<?php echo $SharingTemplates; ?>" class="btn btn-sm btn-success"><i class="fa fa-share"></i> Share Details on Whatsapp</a>
