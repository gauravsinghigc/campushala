...
if (isset($_POST['SaveNewsCompaignsDetails'])) {
 ...
 $Data = [
  ...
  "UploadCreative" => UPLOAD_FILES("../storage/newspapers", "null", $_POST['NewsPaperName'], $_POST['ProjectName'], "UploadCreative"),
 ...
 $UploadCreative = UPLOAD_FILES("../storage/newspapers", "", "News_Paper_Image" . $NewCompaignId, "File", "UploadCreative");
