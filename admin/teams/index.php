                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <a href="tree.php" class="btn btn-xs btn-default pull-right" style="margin-top:-2rem !important;"><i class='fa fa-tree'></i> Group Wise View</a>
                    </div>
                        ...
                        if (LOGIN_UserType == "Admin") {
                          if (LOGIN_UserType == "Admin") {
                            ...
                            if (FETCH($EmpSql, "UserEmpGroupName") == "BM") {
                              ...
                              $leadStages = FETCH_DB_TABLE("SELECT * FROM configs, config_values where ConfigValueDetails!='BM' and configs.ConfigsId=config_values.ConfigValueGroupId and configs.ConfigGroupName='WORK_GROUP'", true);
                            } else {
                              $leadStages = FETCH_DB_TABLE("SELECT * FROM configs, config_values where ConfigValueDetails!='BM' and ConfigValueDetails!='TH' and configs.ConfigsId=config_values.ConfigValueGroupId and configs.ConfigGroupName='WORK_GROUP'", true);
                            }
                          }
                          if ($leadStages != null) {
                          ...
                          <a class="col" href="index.php">
                            <p class="data-list flex-s-b">
                              ...
                              <span class="data-count h5"><?php echo TOTAL("SELECT * FROM users where UserType!='Admin'"); ?></span>
                            </p>
                          </a>
                        <?php } ?>
                      </div>
                    ...
                    <div class="col-md-12">
                      ...
                      if (isset($_GET['view'])) {
                        ...
                        if (LOGIN_UserType == "Admin") {
                          ...
                          $LOGIN_UserId = LOGIN_UserId;
                          $TotalItems = TOTAL("SELECT * FROM users, user_employment_details where user_employment_details.UserEmpReportingMember='$LOGIN_UserId' AND users.UserId=user_employment_details.UserMainUserId ORDER BY UserEmpDetailsId Desc");
                        }
                      }
                      ...
                      if (isset($_GET['view'])) {
                        ...
                        $search_in = $_GET['search_in'];
                        if (LOGIN_UserType == "Admin") {
                          $AllCustomers = FETCH_DB_TABLE("SELECT UserMainUserId,UserEmpGroupName, UserEmpLocations, UserMainUserId  FROM users, user_employment_details where users.UserId=user_employment_details.UserMainUserId and $search_in like '%$search_value%' and UserEmpLocations like '%$location%' and  UserEmpGroupName like '%$UserEmpGroupName%' ORDER BY UserEmpDetailsId Desc limit $start, $listcounts", true);
                        } else {
                          $LOGIN_UserId = LOGIN_UserId;
                          $AllCustomers = FETCH_DB_TABLE("SELECT UserMainUserId,UserEmpGroupName, UserEmpLocations, UserMainUserId  FROM users, user_employment_details where user_employment_details.UserEmpReportingMember='$LOGIN_UserId' AND users.UserId=user_employment_details.UserMainUserId and $search_in like '%$search_value%' and UserEmpLocations like '%$location%' and  UserEmpGroupName like '%$UserEmpGroupName%' ORDER BY UserEmpDetailsId Desc limit $start, $listcounts", true);
                        }
                        ...
                        if (LOGIN_UserType == "Admin") {
                          $AllCustomers = FETCH_DB_TABLE("SELECT UserMainUserId,UserEmpGroupName, UserEmpLocations, UserMainUserId  FROM users, user_employment_details where users.UserId=user_employment_details.UserMainUserId ORDER BY UserEmpDetailsId Desc limit $start, $listcounts", true);
                        } else {
                          $LOGIN_UserId = LOGIN_UserId;
                                ...
                                <span class='w-pr-18'>
                                  <a href="details/?uid=<?php echo SECURE(FETCH("SELECT * FROM users where UserId='$UserMainUserId'", "UserId"), "e"); ?>" class="bold">
                                    <span> <b>
                                        ...
                                        <?php echo FETCH("SELECT * FROM users where UserId='$UserMainUserId'", "UserSalutation"); ?></span> <?php echo FETCH("SELECT * FROM users where UserId='$UserMainUserId'", "UserFullName"); ?></b>
                                  </a>
                                </span>
                                <span class='w-pr-14'>
