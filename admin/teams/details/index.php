                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="data-display">
                                    <ul class="calling-list">
                                       <?php
                                       $fetclFollowUps = FETCH_DB_TABLE("SELECT * FROM lead_followups where LeadFollowUpHandleBy='" . $REQ_UserId . "' and DATE(LeadFollowUpDate)='" . date('Y-m-d') . "' and LeadFollowUpRemindStatus='ACTIVE' ORDER BY LeadFollowUpId DESC", TRUE);
                              ...
                              <div class="col-md-8">
                                 <div class="row">
                                    ...
                                    <div class="col-md-4 col-6 mb-10px">
                                       <a href="LeadsController.php?view=Registration">
                                          <div class="card card-window card-body rounded-3 p-4 shadow-lg">
                                             <div class="flex-s-b">
                                                <h2 class="count text-primary mb-0 m-t-5 h1">
                                             ...
                                             <p class="mb-0 fs-12 text-black">Registrations</p>
                                          </div>
                                       </a>
                                    </div>
                                 ...
                                 <?php
                                 $AllCustomers = FETCH_DB_TABLE("SELECT * FROM user_employment_details where UserEmpReportingMember='$REQ_UserId' ORDER BY UserEmpDetailsId Desc", true);
