<section class="pop-section hidden" id="update_<?php echo $Reward->AppQuotesId; ?>">
 <div class="action-window">
  <div class='container'>
   ...
   <form class="row" action="<?php echo CONTROLLER; ?>/QuotesController.php" method="POST">
    ...
    <div class="col-md-12">
     <div class="row">
      <div class="form-group col-md-4">
       ...
       <input type="date" value="<?php echo $Reward->AppQuoteDate; ?>" required name="AppQuoteDate" class="form-control-sm form-control">
      </div>
      <div class="form-group col-md-4">
       <label>Quote Status</label>
       <select class="form-control form-control-sm" name='AppQuoteStatus' required>
