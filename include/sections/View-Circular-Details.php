    ...
    <div class='container'>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <h5 class="mb-3">
            ...
            <span class="bold"><?php echo DATE_FORMATE("d M, Y", $Record->CircularDate); ?></span>
          </h5>
          <h5 class="mb-3">
        ...
        <div class="col-md-6">
          ...
          <div class="row">
            <?php
            $AllMediafiles = FETCH_DB_TABLE("SELECT * FROM circular_files where CircularMainId='" . $Record->CircularId . "'", true);
      ...
      <div class='row'>
        <div class="col-md-12 text-right">
          <form method="POST" action='<?php echo CONTROLLER; ?>/CircularController.php'>
