...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
              ...
              <div class="card card-primary">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    $AllExpanses = FETCH_DB_TABLE($ExpanseSql . " LIMIT $start, $end", true);
                    if ($AllExpanses == null) {
                    ...
                    ?>
                        <div class="col-md-12">
                          <div class="data-list flex-s-b">
                            ...
                            <span class="w-pr-15">
                              <?php echo DATE_FORMATE("d M, Y", $Expanse->ExpanseDate); ?>
                            </span>
                            <span class="w-pr-15">
                    ...
                    <?php
                        include $Dir . "/include/sections/Update-Expanse-Details.php";
                      }
                    }
    ...
    <?php
    include $Dir . "/include/sections/Add-New-Expanse.php";
