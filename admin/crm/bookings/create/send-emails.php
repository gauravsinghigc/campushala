            ...
            <div class="col-12">
              <div class="card card-primary">
                <div class="card-body">
                  ...
                  <div class="row mt-2">
                    <div class="col-md-12">
                      <h5 class='app-heading'><i class="fa fa-check"></i> Registration Done</h5>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-7">
                      ...
                      <form class="row">
                        <div class="col-md-12 form-group">
                          ...
                          <input type="text" name="SubjectName" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Send to <?php echo $req; ?> <span class='text-grey'>Separated by commas, abc@gmail.com,
                              syx@gmail.com etc</span></label>
                          <textarea name="Mailto" class="form-control form-control-sm" rows="2" required=""></textarea>
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Enter Message<?php echo $req; ?> </label>
                          <textarea name="Message" class="form-control form-control-sm editor" rows="2"></textarea>
                        </div>
                        <div class="col-md-12 form-group">
                          <label>Upload Attachment </label>
                          <input type="FILE" name="Attachement" class="form-control form-control-sm">
                        </div>
                    ...
                    <div class="col-md-5">
                      ...
                      <?php
                      $FetchProjects = FETCH_DB_TABLE("SELECT * FROM projects where ProjectsId='" . FETCH($RegSql, "RegProjectId") . "'", true);
                              ...
                              <div class="table-responsive">
                                <table class="table table-striped">
                                  <tbody>
                                    ...
                                    <tr>
                                      <th>Unit Size</th>
                                      <td><?php echo FETCH($RegSql, "RegUnitSizeApplied"); ?> SQ Yards</td>
                                    </tr>
                                    <tr>
                                      <th>Unit Name</th>
