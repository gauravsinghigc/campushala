  ...
  <div class="col-md-3">
    <a href="crm/reg/">
      <div class="card card-window card-body rounded-3 p-4 shadow-lg">
        <div class="flex-s-b">
          <h2 class="count mb-0 m-t-5 h1">
            <?php echo TOTAL("SELECT RegStatus FROM registrations where RegStatus like '%Active%'"); ?>
          </h2>
        </div>
  ...
  <div class="col-md-3">
    <a href="crm/reg/">
      <div class="card card-window card-body rounded-3 p-4 shadow-lg">
        <div class="flex-s-b">
          <h2 class="count mb-0 m-t-5 h1">
            <?php echo TOTAL("SELECT RegStatus FROM registrations where RegStatus like '%Follow Up%'"); ?>
          </h2>
        </div>
  ...
  <div class="col-md-3">
    <a href="crm/reg/">
      <div class="card card-window card-body rounded-3 p-4 shadow-lg">
        <div class="flex-s-b">
          <h2 class="count mb-0 m-t-5 h1">
            <?php echo TOTAL("SELECT RegStatus FROM registrations where RegStatus like '%cancel%'"); ?>
          </h2>
        </div>
  ...
  <div class="col-md-3">
    <a href="crm/reg/">
      <div class="card card-window card-body rounded-3 p-4 shadow-lg">
        <div class="flex-s-b">
          <h2 class="count mb-0 m-t-5 h1">
            <?php echo TOTAL("SELECT RegStatus FROM registrations where RegStatus like '%Refund%'"); ?>
          </h2>
        </div>
...
<div class='row'>
          ...
          <div class="col-md-12 registrations-data <?php echo $bg; ?>">
            <p class="data-list flex-s-b">
              ...
              <span class='w-pr-15 text-left'>
                <span class="bold">
                  <a href="<?php echo ADMIN_URL; ?>/crm/custs/details/?id=<?php echo $Data->RegMainCustomerId; ?>" class="text-primary">
  ...
  <div class='col-md-12'>
    <h4 class='app-heading'>Latest Payments</h4>
    <div class="row">
      <div class='col-md-12'>
        <p class="data-list flex-s-b app-sub-heading">
          <span class='w-pr-5'>
      ...
      ?>
          <div class='col-md-12 payment-data'>
            <p class="data-list flex-s-b">
              ...
              <span class='w-pr-30'>
                <span class='bold'><?php echo $Data->RegPayCustRefId; ?></span>
              </span>
              <span class='w-pr-20'>
                <span>REG<?php echo $Data->RegMainId; ?></span>
              </span>
              <span class='w-pr-15'>
                <span><?php echo $Data->RegPayMode; ?></span>
              </span>
              <span class='w-pr-25'>
                <span>Rs.<?php echo $Data->RegPayTotalAmount; ?></span>
              </span>
              <span class='w-pr-10'>
                <span><?php echo DATE_FORMATE("d M, Y", $Data->RegPaymentDate); ?></span>
              </span>
              <span class='w-pr-10'>
                <span><?php echo $Data->RegPaymentStatus; ?></span>
              </span>
            </p>
          </div>
      <?php
