                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      <form method="get" action="">
                        ...
                        ?>
                        <input placeholder="Search Uploaded Leads..." type="search" id="searchd" oninput="SearchData('searchd', 'uploaded-data')" class="form-control form-control-sm">
                        <?php
                        if (LOGIN_UserType == "Admin") {
                          ...
                          foreach ($Leads as $Data) {
                            ...
                            <div class="uploaded-data">
                              <p class="data-list flex-s-b">
                                ...
                                <span>
                                  <span class='text-info fs-11'><?php echo $Data->LeadStatus; ?></span>
                                </span>
                              </p>
                            </div>
                        <?php }
