            ...
            <div class="col-12">
              <div class="card card-primary">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <h5 class="app-sub-heading">Available Masters</h5>
                      ...
                      <ul class="config-menu">
                        <?php
                        $Configs = FETCH_DB_TABLE("SELECT * FROM configs ORDER By ConfigsId DESC", true);
                        if ($Configs != null) {
                          $Count = 0;
                    ...
                    <div class="col-md-8">
                      <h5 class="app-sub-heading">Masters Values</h5>
                      <form action="../../controller/configcontroller.php" method="POST">
                        <div class="row">
                          <?php
                          if (isset($_GET['id'])) {
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                <select name="ConfigReferenceId" class="form-control" required>
                                  ...
                                  <?php $ConfigsOptions = FETCH_DB_TABLE("SELECT * FROM config_values where ConfigValueGroupId='7'", true);
                      ...
                      <hr>
                      <?php
                      $CValues = FETCH_DB_TABLE($ConfigSql, true);
                      if ($CValues != null) {
