                    ...
                    <div class="col-md-7">
                      ...
                      <form class="row" action="payment-details.php" method="POST">
                        <div class="col-md-4 form-group">
                          ...
                          <input type="date" name="RegistrationDate" value="<?php echo date("Y-m-d"); ?>" class=" form-control form-control-sm" required="">
                        </div>
                        <div class="col-md-4 form-group">
                          <label>Acknowledge Code <?php echo $req; ?></label>
                          <input type="text" value="<?php echo $Code; ?>" name="RegAcknowledgeCode" list="RegAcknowledgeCode" class="form-control form-control-sm" required="">
                          <?php echo SUGGEST("registrations", "RegAcknowledgeCode", "ASC"); ?>
                        </div>
                        <div class="col-md-4 form-group">
                          <label>Reminder in Days (O for Disable)</label>
                          <input type="number" value="0" min='0' name="RegProjectCost" class="form-control form-control-sm">
                        </div>
                        <div class="col-md-6 form-group">
                          <label>Allotment Phase <?php echo $req; ?></label>
                          <input type="text" value="<?php echo FETCH($BookingSql, "BookingProjectPhase"); ?>" name="RegAllotmentPhase" list="RegAllotmentPhase" class="form-control form-control-sm" required="">
                          <?php echo SUGGEST("registrations", "RegAllotmentPhase", "ASC"); ?>
                        </div>
                        <div class="col-md-6 form-group">
                          <label>Project name <?php echo $req; ?></label>
                          <select readonly="" name="RegProjectId" class="form-control form-control-sm">
                        ...
                        <div class="col-md-3 form-group">
                          ...
                          <input type="text" name="RegUnitSizeApplied" oninput="CheckCost()" id='unitSize' list="RegUnitSizeApplied" class="form-control form-control-sm" required="">
                        </div>
                        <div class="col-md-3 form-group">
                        ...
                        <div class="col-md-3 form-group">
                          ...
                          <input type="text" name="UnitRate" oninput="CheckCost()" id='unitRate' class="form-control form-control-sm" required="">
                        </div>
                        <div class="col-md-3 form-group">
                          <label>Unit Cost <?php echo $req; ?></label>
                          <input type="text" name="RegUnitCost" oninput="CheckCost()" id='unitCost' list="RegUnitCost" class="form-control form-control-sm" required="">
                          <?php echo SUGGEST("registrations", "RegUnitCost", "ASC"); ?>
                        </div>
                        <div class="col-md-4 form-group">
                          <label>Unit Alloted <?php echo $req; ?></label>
                          <input type="text" name="RegUnitAlloted" list="RegUnitAlloted" class="form-control form-control-sm" required="">
                        ...
                        <div class="col-md-12 form-group">
                          ...
                          <textarea class="form-control form-control-sm" name="RegNotes" rows="2" required=""></textarea>
                        </div>
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="row">
                            <div class="col-md-4 form-group">
                              ...
                              <select name="PLC_CHARGES_STATUS" id='plcstatus' class="form-control form-control-sm" required="">
                              ...
                              <div class='hidden' id='plcview'>
                                <div class='row'>
                                  ...
                                  <div class="col-md-6 form-group">
                                    ...
                                    <input type='text' name='PLC_CHARGE_VALUE' list='plcperlist' class='form-control form-control-sm'>
                              ...
                              <div class="col-md-12">
                                ...
                                <div class='table-responsive'>
                                  <table class='table table-striped'>
                                    <tbody>
                                      <?php
                                      $AllMediaFiles = FETCH_DB_TABLE("SELECT * FROM project_media_files where ProjectMainId='" . $Data->ProjectsId . "'", true);
