<section class="pop-section hidden" id="update_issue_assets_for_<?php echo $IAS->AssetsMoveId; ?>">
  <div class="action-window">
    <div class='container'>
      ...
      <form class="row" action="<?php echo CONTROLLER; ?>/AssetsController.php" method="POST">
        ...
        <div class="col-md-12">
          <div class="row">
                    ...
                    <p class="mb-2">
                      <span class="fs-17"><?php echo GET_DATA("assets", "AssetName", "AssetsId='" . $IAS->AssetsMainId . "'", null); ?>
                        <i class="pull-right fs-13 text-secondary italic">
                          <?php echo DATE_FORMATE("d M, Y", GET_DATA("assets", "AssetPurchaseDate", "AssetsId='" . $IAS->AssetsMainId . "'", null)); ?>
                        </i>
                      </span>
                      <br>
              ...
              <div class="mt-1">
                <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <input type="date" value="<?php echo $IAS->AssetsIssueDate; ?>" required name="AssetsIssueDate" class="form-control-sm form-control">
                  </div>
                  <div class="form-group col-md-12">
            ...
            <div class="col-md-6">
              ...
              <input type="search" name="search" id="search34" oninput="SearchData('search34', 'record-data-65')" class='form-control form-control-sm' placeholder="Search Team Member">
              <div class='data-display height-limit'>
                <?php
                $AllUsers = FETCH_DB_TABLE("SELECT UserId, UserFullName, UserPhoneNumber, UserEmailId FROM users where UserId='" . $IAS->AssetsIssuedTo . "' and UserStatus='1' ORDER BY UserFullName ASC", true);
                if ($AllUsers == null) {
