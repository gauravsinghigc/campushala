...
if (isset($_POST['UpdateAddress'])) {
    ...
    $RegDocs = [
        ...
        "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", $_POST['CustomerDocmentType'], $_POST['CustomerDocumentName'], "CustomerDocumentAttachement"),
