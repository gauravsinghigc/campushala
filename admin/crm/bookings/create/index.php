...
if (isset($_GET['bid'])) {
  ...
  header("location: project-details.php?CustomerId=$CustomerId&ProjectName=$ProjectName");
} else {
                  ...
                  <div class="row mt-2">
                    <div class="col-md-8">
                      <h5 class='app-sub-heading'>Search Customers
                        <span class="pull-right"><?php echo TOTAL("SELECT * FROM customers"); ?> Customers Exits</span>
                      </h5>
                      <form class="row">
                        <div class="col-md-3 form-group">
                          <select name="searchby" onchange="form.submit()" class="form-control form-control-sm">
                            <?php
                        ...
                        <div class="col-md-5 form-group">
                          <input type="<?php echo $inputype; ?>" onchange="form.submit()" id="searchvalue" list="suggestionlist" placeholder="Enter <?php echo IfRequested("GET", "searchby", "Search Value", false); ?>" name="searchvalue" class="form-control form-control-sm" required="">
                          <datalist id="suggestionlist">
                            <?php
                            $Alldata = FETCH_DB_TABLE("SELECT * FROM customers ORDER BY CustomerName", true);
                            if ($Alldata != null) {
                      ...
                      <div class="row">
                        <?php if (isset($_GET['searchvalue']) != null) {
                          ...
                          $FetchResults = FETCH_DB_TABLE("SELECT * FROM customers where $SearchBy like '%$SearchedValues%'", true);
                                ...
                                <div class="shadow-sm p-2 rounded">
                                  <div class="flex-s-b">
                                    ...
                                    <div class="w-pr-90 p-2">
                                      ...
                                      <p><?php echo $Data->CustomerPhoneNumber; ?>, <?php echo $Data->CustomerEmailId; ?></p>
