                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-7 col-12 text-right">
                      <?php if (LOGIN_UserType == "Admin") { ?>
                        <a href="../digital/uploads/" class="btn btn-sm btn-dark m-1"><i class="fa fa-upload"></i> Upload Bulk Leads</a>
                      <?php } ?>
                      <?php
                      ...
                      if ($CheckReportingManagersStatus != NULL) { ?>
                        <a href="../digital/uploaded/" class="btn btn-sm btn-dark m-1">Uploaded Leads</a>
                        <a href="../digital/transfer/" class="btn btn-sm btn-dark m-1">Move Leads <i class="fa fa-exchange"></i></a>
                      <?php } ?>
                      ...
                      <form class="row">
                        ...
                        <div class="col-md-3 col-6">
                          ...
                          if (LOGIN_UserType == "Admin") {
                            ...
                            $ManagedByValue = LOGIN_UserId;
                            $ManagedByStatus = "readonly";
                          } ?>
                          <input type="text" <?php echo $ManagedByStatus; ?> value="<?php echo $ManagedByValue; ?>" name="LeadPersonManagedBy" list="LeadPersonManagedBy" class="form-control form-control-sm" placeholder="Lead Managed By">
                        </div>
                        <div class="col-md-2 col-6">
                  ...
                  <div class="row">
                    ...
                    if (isset($_GET['view'])) {
                      $view = $_GET['view'];
                      if (LOGIN_UserType == "Admin") {
                        $GetLeads = FETCH_DB_TABLE("SELECT LeadPersonCreatedBy, LeadPersonStatus, LeadSalutations, LeadPersonFullname, LeadPersonManagedBy, LeadPersonSource, LeadPriorityLevel, LeadPersonCreatedAt, LeadsId  FROM leads WHERE LeadPersonStatus LIKE '%$view%' GROUP BY LeadsId ORDER by LeadsId DESC limit $start, $listcounts", true);
                      } else {
                        $LOGIN_UserId = LOGIN_UserId;
                        $GetLeads = FETCH_DB_TABLE("SELECT LeadPersonCreatedBy, LeadPersonStatus, LeadSalutations, LeadPersonFullname, LeadPersonManagedBy, LeadPersonSource, LeadPriorityLevel, LeadPersonCreatedAt, LeadsId  FROM leads where LeadPersonStatus LIKE '%$view%' and LeadPersonManagedBy='$LOGIN_UserId' GROUP BY LeadsId ORDER by LeadsId DESC limit $start, $listcounts", true);
                      }
                      ...
                      if (LOGIN_UserType == "Admin") {
                        $GetLeads = FETCH_DB_TABLE("SELECT LeadPersonCreatedBy, LeadPersonStatus, LeadSalutations, LeadPersonFullname, LeadPersonManagedBy, LeadPersonSource, LeadPriorityLevel, LeadPersonCreatedAt, LeadsId  FROM leads WHERE $Managed LeadPersonSource like '%$LeadPersonSource%' and LeadPriorityLevel like '%$LeadPriorityLevel%' and LeadPersonPhoneNumber like '%$LeadPersonPhoneNumber%' and LeadPersonFullname like '%$LeadPersonFullname%' and LeadPersonSubStatus like '%$LeadPersonSubStatus%' and LeadPersonStatus LIKE '%$LeadPersonStatus%' GROUP BY LeadsId ORDER by LeadsId DESC limit $start, $listcounts", true);
                      } else {
                        $LOGIN_UserId = LOGIN_UserId;
                      ...
                      if (LOGIN_UserType == "Admin") {
                        $GetLeads = FETCH_DB_TABLE("SELECT LeadPersonCreatedBy, LeadPersonStatus, LeadSalutations, LeadPersonFullname, LeadPersonManagedBy, LeadPersonSource, LeadPriorityLevel, LeadPersonCreatedAt, LeadsId  FROM leads WHERE LeadPersonSubStatus like '%$sub_status%' GROUP BY LeadsId ORDER by LeadsId DESC limit $start, $listcounts", true);
                      } else {
                        $LOGIN_UserId = LOGIN_UserId;
                        $GetLeads = FETCH_DB_TABLE("SELECT LeadPersonCreatedBy, LeadPersonStatus, LeadSalutations, LeadPersonFullname, LeadPersonManagedBy, LeadPersonSource, LeadPriorityLevel, LeadPersonCreatedAt, LeadsId  FROM leads where LeadPersonSubStatus like '%$sub_status%' and LeadPersonManagedBy='$LOGIN_UserId' GROUP BY LeadsId ORDER by LeadsId DESC limit $start, $listcounts", true);
                      }
                    } else {
                      if (LOGIN_UserType == "Admin") {
                        $GetLeads = FETCH_DB_TABLE("SELECT LeadPersonCreatedBy, LeadPersonStatus, LeadSalutations, LeadPersonFullname, LeadPersonManagedBy, LeadPersonSource, LeadPriorityLevel, LeadPersonCreatedAt, LeadsId FROM leads GROUP BY LeadsId ORDER by LeadsId DESC limit $start,$listcounts", true);
                      } else {
                        $LOGIN_UserId = LOGIN_UserId;
                        $GetLeads = FETCH_DB_TABLE("SELECT LeadPersonCreatedBy, LeadPersonStatus, LeadSalutations, LeadPersonFullname, LeadPersonManagedBy, LeadPersonSource, LeadPriorityLevel, LeadPersonCreatedAt, LeadsId  FROM leads where LeadPersonManagedBy='$LOGIN_UserId' GROUP BY LeadsId ORDER by LeadsId DESC limit $start, $listcounts", true);
                      }
                    }
                    if ($GetLeads == null) { ?>
                      <div class="col-md-12">
