...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
                ...
                <div class="card-body">
                  <div class='row'>
                    <div class="col-md-12">
                      <h4 class='app-heading'><?php echo $PageName; ?>
                        <a href="#" onclick="Databar('AddNewCustomers')" class="btn btn-sm btn-default pull-right"><i class="fa fa-plus"></i> Add Customers</a>
                      </h4>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-5 col-9">
                      <form class="flex-s-b">
                        <input onchange='form.submit()' placeholder="Customer name...." type="search" value="<?php echo IfRequested("GET", "search", "", false); ?>" name="search" class="form-control form-control-sm m-r-10">
                        <input onchange='form.submit()' placeholder="Customer phone...." type="search" value="<?php echo IfRequested("GET", "phone", "", false); ?>" name="phone" class="form-control form-control-sm">
                      </form>
                    </div>
                    <div class="col-5">
                  ...
                  <div class="row">
                    ...
                    if (isset($_GET['search'])) {
                      $AllCustomers = FETCH_DB_TABLE("SELECT * FROM customers where CustomerName like '%" . $_GET['search'] . "%' and CustomerPhoneNumber like '%" . $_GET['phone'] . "%' ORDER BY CustomerId DESC", true);
                    } else {
                      $AllCustomers = FETCH_DB_TABLE("SELECT * FROM customers ORDER BY CustomerId DESC limit $start, $listcounts", true);
                    }
                    ...
                    ?>
                        <div class='col-md-12 customer-data'>
                          <p class="data-list flex-s-b">
                            ...
                            <span class='w-pr-10'>
                              <span><?php echo DATE_FORMATE("d M, Y", $Data->CustomerBirthdate); ?></span>
                            </span>
    ...
    <?php
    include $Dir . "/include/sections/Add-New-Customer.php";
