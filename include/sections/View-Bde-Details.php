<section class="pop-section hidden" id="view_bdes_<?= $value->bdes_id ?>">
  <div class="action-window">
    <div class='container'>
      <div class='row'>
        <div class='col-md-12'>
          <h4 class='app-heading'>View Users/BDEs Details</h4>
        </div>
      </div>
            ...
            <div class="col-md-12">
              <div class="card student-card mx-auto">
                ...
                <div class="col-md-12 d-flex justify-content-between btn">
                  <a href="#" onclick="Databar('view_bdes_<?= $value->bdes_id ?>')" class="btn btn-sm btn-default cancel">Cancel</a>
