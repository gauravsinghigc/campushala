                    ...
                    <div class="col-md-8">
                      ...
                      <form method="get" action="">
                        ...
                        if (isset($_GET['LeadsName'])) {
                          ...
                          $LeadsCity = $_GET['LeadsCity'];
                          $LeadsSource = $_GET['LeadsSource'];
                          $Leads = FETCH_DB_TABLE("SELECT leadsUploadId, LeadsName, LeadsPhone, LeadsEmail, LeadsCity, LeadsSource, UploadedOn, LeadStatus  FROM lead_uploads where LeadStatus='UPLOADED' and LeadsName like '%$LeadsName%' and LeadsPhone like '%$LeadsPhone%' and LeadsCity like '%$LeadsCity%' and LeadsSource like '%$LeadsSource%'", true);
                        } else {
                          $Leads = FETCH_DB_TABLE("SELECT leadsUploadId, LeadsName, LeadsPhone, LeadsEmail, LeadsCity, LeadsSource, UploadedOn, LeadStatus  FROM lead_uploads where LeadStatus='UPLOADED' limit $start, $listcounts", true);
                        }
                        if ($Leads != null) {
                          $Sno = 0;
                          if (isset($_GET['view_page'])) {
