     ...
     <div class="box-shadow">
       ...
       <p class="mb-1 mt-2">
         <span><i class="fa fa-birthday-cake text-danger"></i>
           <?php echo DATE_FORMATE("d M, Y", FETCH($CustomerSql, "CustomerBirthdate")); ?></span>
       </p>
       ...
       <div class='row'>
         ...
         <div class="col-md-4">
           ...
           <div>
             ...
             <div class='data-list'>
               <div class="p-1">
                 <span class='text-gray'>RNA-<?php echo FETCH("SELECT * FROM user_employment_details where UserMainUserId='$ManagedBy'", 'UserMainUserId'); ?></span>
         ...
         <div class="col-md-3">
           <div class="card card-body p-2">
             <h5 class="mb-0">
               <?php
                $NetPaid = 0;
                $NetPaid += AMOUNT("SELECT * FROM registration_payments, registrations where registrations.RegMainCustomerId='$ViewCustomerId' and registrations.RegistrationId=registration_payments.RegMainId and registrations.RegistrationId and RegPaymentStatus like '%Paid%'", "RegPayTotalAmount");
                $NetPaid += AMOUNT("SELECT * FROM registration_payments, registrations where registrations.RegMainCustomerId='$ViewCustomerId' and registrations.RegistrationId=registration_payments.RegMainId and registrations.RegistrationId and RegPaymentStatus like '%Cleared%'", "RegPayTotalAmount");
