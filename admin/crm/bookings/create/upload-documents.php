...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
            ...
            <div class="col-12">
              <div class="card card-primary">
                <div class="card-body">
                  ...
                  <form action="<?php echo CONTROLLER; ?>/RegistrationController.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                          ...
                          <input type="file" name="CUSTOMER_PHOTO" class="form-control form-control-sm">
                        </div>
                        <div class="flex-s-b">
                          <div class="form-group">
                            <label>Pancard No </label>
                            <input type="text" name="CUSTOMER_PAN_CARD_NO" class="form-control form-control-sm">
                          </div>
                          <div class="form-group ml-1">
                            <label>Upload Pancard </label>
                            <input type="file" name="CUSTOMER_PAN_CARD_FILE" class="form-control form-control-sm">
                          </div>
                        </div>
                        ...
                        <div class="flex-s-b">
                          <div class="form-group">
                            ...
                            <input type="text" name="CUSTOMER_ADHAAR_CARD_NO" class="form-control form-control-sm">
                          </div>
                          <div class="form-group ml-1">
                            <label>Upload Adhaar Card </label>
                            <input type="file" name="CUSTOMER_ADHAAR_CARD_FILE" class="form-control form-control-sm">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="flex-s-b">
                          <div class="form-group">
                            ...
                            <input type="text" name="REG_DOC_NAME_1" class="form-control form-control-sm">
                          </div>
                          <div class="form-group ml-1">
                            <label>Upload File </label>
                            <input type="file" name="REG_DOC_NAME_1_FILE" class="form-control form-control-sm">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group ml-1">
                          ...
                          <input type="file" name="PAYMENT_RECEIPT" class="form-control form-control-sm">
                        </div>
                      </div>
    ...
    <?php
    include $Dir . "/include/sections/Add-New-Co-Applicants.php";
    include $Dir . "/include/sections/Add-New-Nominee-Details.php";
