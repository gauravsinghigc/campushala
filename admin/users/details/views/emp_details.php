<div class="row">
    ...
    <div class="col-md-12">
        <form action="<?php echo CONTROLLER; ?>/UserController.php" method="POST" class="mt-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    ...
                    <select class="form-control form-control-sm" name="UserEmpLocations">
                        <?php InputOptions(["Noida" => "Noida", "Gurgaon" => "Gurgaon"], FETCH($EmpSql, "UserEmpLocations")); ?>
                    </select>
                </div>
                <div class="col-md-4 form-group">
