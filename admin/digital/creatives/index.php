                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                      <h5 class='app-heading'>
                        <?php echo $PageName; ?>
                        <a href="add.php" class='btn btn-sm btn-default pull-right' style="margin-top:-0.25rem !important;"><i class='fa fa-plus'></i> Add Creative</a>
                      </h5>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      $AllData = FETCH_DB_TABLE("SELECT * FROM creatives order by date(ExecutionDate) DESC limit $start, $listcounts", true);
                      if ($AllData == null) {
                        ...
                        foreach ($AllData as $data) { ?>
                          <p class="data-list flex-s-b">
                            ...
                            <span class="w-pr-10">
                              <span><?php echo DATE_FORMATE("d M, Y", $data->CreatedOn); ?></span>
                            </span>
                            <span class="w-pr-10">
                              <span><?php echo DATE_FORMATE("d M, Y", $data->ExecutionDate); ?></span>
                            </span>
