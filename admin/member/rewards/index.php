                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_rewards where RewardMainUserId='" . LOGIN_UserId . "'"); ?></h1>
                        <p class="text-gray">All Rewards</p>
                      </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_rewards where RewardMainUserId='" . LOGIN_UserId . "' and DATE(RewardReceiveDate)='" . date('Y-m-d') . "'"); ?></h1>
                        <p class="text-gray">Today Rewards</p>
                      </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_rewards where RewardMainUserId='" . LOGIN_UserId . "' and YEAR(RewardReceiveDate)='" . date('Y') . "' and MONTH(RewardReceiveDate)='" . date('m') . "'"); ?></h1>
                        <p class="text-gray">Current Month Rewards</p>
                      </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_rewards where RewardMainUserId='" . LOGIN_UserId . "' and YEAR(RewardReceiveDate)='" . date('Y') . "'"); ?></h1>
                  ...
                  <div class="row">
                    ...
                    if (isset($_GET['RewardName'])) {
                      $AllRewards = FETCH_DB_TABLE("SELECT * FROM user_rewards where RewardName like '%" . $_GET['RewardName'] . "%' and RewardMainUserId='" . LOGIN_UserId . "' ORDER by DATE(RewardReceiveDate) DESC", true);
                    } else {
                      $AllRewards = FETCH_DB_TABLE("SELECT * FROM user_rewards where RewardMainUserId='" . LOGIN_UserId . "' ORDER by DATE(RewardReceiveDate) DESC limit $start, $end", true);
                    }
                    if ($AllRewards == null) {
