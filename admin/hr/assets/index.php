                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-5">
                      ...
                      <hr>
                      <?php
                      $AllAssets = FETCH_DB_TABLE("SELECT * FROM assets ORDER BY AssetName ASC", true);
                      if ($AllAssets == null) {
                      ...
                      <?php
                          include $Dir . "/include/sections/Update-Asset-Details.php";
                          include $Dir . "/include/sections/Add-Assets-Issue-Record.php";
                        }
                      } ?>
                    </div>
                    <div class="col-md-7">
                      ...
                      <?php
                      $IssuedAssets = FETCH_DB_TABLE("SELECT * FROM assets_issued where AssetsIssueStatus='ISSUED' ORDER BY AssetsIssueDate ASC", true);
                      ...
                      <?php
                          include $Dir . "/include/sections/Update-Assets-Issue-Details.php";
                          include $Dir . "/include/sections/Update-Assets-As-Return.php";
                        }
                      } ?>
                    </div>
                  </div>
