...
if (isset($_POST['SaveCreatives'])) {
 ...
 $Data = [
  ...
  "UploadCreative" => UPLOAD_FILES("../storage/creatives", "null", $_POST['CreativeName'], $_POST['CreativeOccasion'], "UploadCreative"),
 ...
 $UploadCreative = UPLOAD_FILES("../storage/creatives", "", "Creative_Image" . $NewCompaignId, "File", "UploadCreative");
