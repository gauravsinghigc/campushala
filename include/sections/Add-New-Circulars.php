<section class="pop-section hidden" id="AddNewCirculars">
  <div class="action-window">
    <div class='container'>
      ...
      <form class="row" action="<?php echo CONTROLLER; ?>/CircularController.php" enctype="multipart/form-data" method="POST">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <input type="text" required name="CircularName" class="form-control-sm form-control">
            </div>
            <div class="form-group col-md-6">
              <label>Mail Subject</label>
              <input type="text" required name="CircularSubject" class="form-control-sm form-control">
            </div>
            <div class="form-group col-md-6">
              <label>Circular Date</label>
              <input type="date" value="<?php echo date('Y-m-d'); ?>" required name="CircularDate" class="form-control-sm form-control">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="col-md-12">
              ...
              <input type='FILE' name='CircularDocumentFile' class="form-control form-control-sm">
            </div>
          </div>
        </div>
