 <div class="card card-body p-2">
   ...
   <div class="data-display-2 height-limit">
     <ul>
       <?php
        $AllData = FETCH_DB_TABLE("SELECT * FROM booking_refunds, bookings where booking_refunds.BookingMainId=bookings.bookingId and bookings.BookingMainCustomerId='$ViewCustomerId' ORDER BY BookingRefundId  DESC", true);
        if ($AllData != null) {
          $SerialNo = 0;
           ...
           <li class="data-list">
             <p class="flex-s-b">
               <span class='w-pr-18 text-left'>
                 ...
                 <span class='btn btn-sm text-info'><?php echo DATE_FORMATE("d M, Y", $Data->BookingRefundCreatedAt); ?></span>
               </span>
               <span class='w-pr-20'>
               ...
               <span class='w-pr-17 text-right p-1'>
                 <a href="<?php echo ADMIN_URL; ?>/crm/reg/details/?bid=<?php echo SECURE($Data->bookingId, "e"); ?>" class='btn btn-xs btn-default'><i class='fa fa-file text-danger'></i> View Details</a>
               </span>
             </p>
           </li>
       <?php
