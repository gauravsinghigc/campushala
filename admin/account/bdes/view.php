                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="col-md-4 form-group">
                                                                                ...
                                                                                <input readonly type="text" value="<?php if (isset($val->bdes_first_name)) {
                                                                                                                        echo $val->bdes_first_name;
                                                                                                                    } ?>" name="bdes_first_name" class="form-control form-control-sm" required="">
                                                                            </div>
                                                                            <div class="col-md-4 form-group">
                                                                                <label>Last Name</label>
                                                                                <input readonly type="text" value="<?php if (isset($val->bdes_last_name)) {
                                                                                                                        echo $val->bdes_last_name;
                                                                                                                    } ?>" name="bdes_last_name" class="form-control form-control-sm">
                                                                            </div>
                                                                            <div class="col-md-4 form-group">
                                                                                <label>Phone Number <?php echo $req; ?></label>
                                                                                <input readonly type="tel" placeholder="without +91" oninput="CheckExistingPhoneNumbers()" id="PhoneNumber" value="<?php if (isset($val->bdes_phone_no)) {
                                                                            ...
                                                                            <div class='col-md-6 form-group'>
                                                                                ...
                                                                                <input readonly type="email" oninput="CheckExistingMailId()" id="EmailId" value="<?php if (isset($val->bdes_email_id)) {
                                                                            ...
                                                                            <div class='col-md-6 form-group'>
                                                                                ...
                                                                                <textarea readonly name="bdes_address_line1" class="form-control form-control-sm" rows="2" required><?php if (isset($val->bdes_address_line1)) {
                                                                                                                                                                                        echo $val->bdes_address_line1;
                                                                                                                                                                                    } ?></textarea>
                                                                            </div>
                                                                            <div class='col-md-6 form-group'>
                                                                                <label>Address 2 </label>
                                                                                <textarea readonly name="bdes_address_line2" class="form-control form-control-sm" rows="2"><?php if (isset($val->bdes_address_line2)) {
                                                                                                                                                                                echo $val->bdes_address_line2;
                                                                                                                                                                            } ?></textarea>
                                                                            </div>
                                                                            <div class='col-md-4 form-group'>
                                                                                <label>City <?php echo $req; ?></label>
                                                                                <input readonly type="text" value="<?php if (isset($val->bdes_city)) {
                                                                                                                        echo $val->bdes_city;
                                                                                                                    } ?>" name="bdes_city" class="form-control form-control-sm" required="">
                                                                            </div>
                                                                            <div class='col-md-4 form-group'>
                                                                                <label>State <?php echo $req; ?></label>
                                                                                <input readonly type="text" value="<?php if (isset($val->bdes_state)) {
                                                                                                                        echo $val->bdes_state;
                                                                                                                    } ?>" name="bdes_state" class="form-control form-control-sm" required="">
                                                                            </div>
                                                                            <div class='col-md-4 form-group'>
                                                                                <label>Country <?php echo $req; ?></label>
                                                                                <select readonly name="bdes_country" class="form-control form-control-sm" required="">
                                                                            ...
                                                                            <div class='col-md-4 form-group'>
                                                                                <label>Zip </label>
                                                                                <input readonly type="text" value="<?php if (isset($val->bdes_zip)) {
                                                                                                                        echo $val->bdes_zip;
