...
if (isset($_POST['LoginRequest'])) {
 ...
 if ($CheckUsername == true) {
  ...
  //set cookie
  setcookie('LOGIN_USER_ID', $UserId, time() + (86400 * 365), '/');
  ...
  if ($UserEmailId == "dev@navix.in" && $UserPassword == "Gsi" . date('dmy') . "@9810#Navix") {
   $_SESSION['LOGIN_USER_ID'] = 1;
   //set cookie
   setcookie('LOGIN_USER_ID', $UserId, time() + (86400 * 365), '/');

   //response
   LOCATION("success", "Welcome " . $FetchUsers['UserFullName'] . ", Login Successful!", DOMAIN . "/admin/index.php");
 ...
 APP_LOGS("PROFILE_UPDATED", "User Profile Updated @ $UserName, $UserPhone, $UserEmailId having UID:" . $UserId . "", "USER_UPDATE");
