              ...
              <div class="card card-primary">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_appraisals where DATE(UserAppraisalDate)='" . date('Y-m-d') . "'"); ?></h1>
                        <p class="text-gray">Today Appraisals</p>
                      </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_appraisals where YEAR(UserAppraisalDate)='" . date('Y') . "' and MONTH(UserAppraisalDate)='" . date('m') . "'"); ?></h1>
                        <p class="text-gray">Current Month Appraisals</p>
                      </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_appraisals where YEAR(UserAppraisalDate)='" . date('Y') . "'"); ?></h1>
                  ...
                  <form class="row mt-2">
                    ...
                    <div class="col-md-4 form-group">
                      <select name="UserAppraisalMainUserId" class="form-control form-control-sm" required="" onchange="form.submit()">
                  ...
                  <div class="row">
                    ...
                    if (isset($_GET['UserAppraisalName'])) {
                      $AllRewards = FETCH_DB_TABLE("SELECT * FROM user_appraisals where UserAppraisalName like '%" . $_GET['UserAppraisalName'] . "%' and UserAppraisalMainUserId='" . $_GET['UserAppraisalMainUserId'] . "' ORDER by DATE(UserAppraisalDate) DESC", true);
                    } else {
                      $AllRewards = FETCH_DB_TABLE("SELECT * FROM user_appraisals ORDER by DATE(UserAppraisalDate) DESC limit $start, $end", true);
                    }
                    if ($AllRewards == null) {
                    ...
                    <?php
                        include $Dir . "/include/sections/Update-Appraisales-Details.php";
                      }
                    }
