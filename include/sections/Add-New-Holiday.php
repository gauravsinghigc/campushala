        ...
        <div class="col-md-12">
          <div class="row">
            <div class="form-group col-md-5">
              ...
              <input type="text" required name="ConfigHolidayName" class="form-control-sm form-control">
            </div>
            <div class="form-group col-md-2">
              <label>Holiday date</label>
              <input type="date" value="<?php echo date('Y-m-d'); ?>" required name="ConfigHolidayFromDate" class="form-control-sm form-control">
            </div>
