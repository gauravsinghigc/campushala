<section class="pop-section hidden" id="update_<?php echo $Expanse->ExpansesId; ?>">
 <div class="action-window">
  <div class='container'>
   ...
   <form class="row" action="<?php echo CONTROLLER; ?>/ExpanseController.php" enctype="multipart/form-data" method="POST">
    <?php FormPrimaryInputs(true, [
     "ExpansesId" => $Expanse->ExpansesId
    ]); ?>
    <div class="form-group col-md-6">
     <label>Expanse name</label>
     <input type="text" value="<?php echo $Expanse->ExpanseName; ?>" required name="ExpanseName" class="form-control-sm form-control">
     <?php SUGGEST("expanses", "ExpanseName", "ASC"); ?>
    </div>
    <div class="form-group col-md-3">
     <label>Expanse Category</label>
     <input type="text" required value="<?php echo $Expanse->ExpanseCategory; ?>" name="ExpanseCategory" list="ExpanseCategory" class="form-control-sm form-control">
     <?php SUGGEST("expanses", "ExpanseCategory", "ASC"); ?>
    </div>
    <div class="form-group col-md-3">
     <label>Expanse Tags</label>
     <input type="text" required name="ExpanseTags" value="<?php echo $Expanse->ExpanseTags; ?>" list="ExpanseTags" class="form-control-sm form-control">
     <?php SUGGEST("expanses", "ExpanseTags", "ASC"); ?>
    </div>
    <div class="form-group col-md-3">
     <label>Expanse Amount</label>
     <input type="text" required name="ExpanseAmount" value="<?php echo $Expanse->ExpanseAmount; ?>" class="form-control-sm form-control">
    </div>
    <div class="form-group col-md-3">
     <label>Expanse Date</label>
     <input type="date" value="<?php echo $Expanse->ExpanseDate; ?>" required name="ExpanseDate" class="form-control-sm form-control">
    </div>
    <div class="col-md-6">
     <label>Upload expanse receipt <span class="text-secondary">(png, jpeg only)</span></label>
     <input type='FILE' name='ExpanseReceiptAttachment' accept="image/*" class="form-control form-control-sm">
    </div>
