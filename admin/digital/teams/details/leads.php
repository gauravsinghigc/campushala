                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="card p-2">
                                    ...
                                    <p class="display-6">
                                       ...
                                       <span><b>DOB :</b> <?php echo DATE_FORMATE("d M, Y", FETCH($PageSqls, "UserDateOfBirth")); ?></span><br>
                              ...
                              <div class="col-md-8">
                                 <div class="row">
                                    ...
                                    <div class="col-md-4 col-6 mb-10px">
                                       <a href="LeadsController.php?view=Fresh Lead">
                                          <div class="card card-window card-body rounded-3 p-4 shadow-lg">
                                             <div class="flex-s-b">
                                                <h2 class="count text-primary mb-0 m-t-5 h1">
                                    ...
                                    <div class="col-md-4 col-6 mb-10px">
                                       <a href="LeadsController.php?view=Follow up">
                                          <div class="card card-window card-body rounded-3 p-4 shadow-lg">
                                             <div class="flex-s-b">
                                                <h2 class="count text-primary mb-0 m-t-5 h1">
                                    ...
                                    <div class="col-md-4 col-6 mb-10px">
                                       <a href="LeadsController.php?sub_status=Site Visit Planned">
                                          <div class="card card-window card-body rounded-3 p-4 shadow-lg">
                                             <div class="flex-s-b">
                                                <h2 class="count text-primary mb-0 m-t-5 h1">
                                    ...
                                    <div class="col-md-4 col-6 mb-10px">
                                       <a href="LeadsController.php?sub_status=RINGING">
                                          <div class="card card-window card-body rounded-3 p-4 shadow-lg">
                                             <div class="flex-s-b">
                                                <h2 class="count text-primary mb-0 m-t-5 h1">
                                    ...
                                    <div class="col-md-4 col-6 mb-10px">
                                       <a href="LeadsController.php?sub_status=Site Visit Done">
                                          <div class="card card-window card-body rounded-3 p-4 shadow-lg">
                                             <div class="flex-s-b">
                                                <h2 class="count text-primary mb-0 m-t-5 h1">
                                    ...
                                    <div class="col-md-4 col-6 mb-10px">
                                       <a href="LeadsController.php?view=Sale Close">
                                          <div class="card card-window card-body rounded-3 p-4 shadow-lg">
                                             <div class="flex-s-b">
                                                <h2 class="count text-primary mb-0 m-t-5 h1">
                                    ...
                                    <div class="col-md-4 col-6 mb-10px">
                                       <a href="LeadsController.php?view=Not Interested">
                                          <div class="card card-window card-body rounded-3 p-4 shadow-lg">
                                             <div class="flex-s-b">
                                                <h2 class="count text-primary mb-0 m-t-5 h1">
                                 ...
                                 <div class="row">
                                    ...
                                    if (isset($_GET['view'])) {
                                       $view = $_GET['view'];
                                       $GetLeads = FETCH_DB_TABLE("SELECT * FROM leads where LeadPersonStatus LIKE '%$view%' and LeadPersonManagedBy='$LOGIN_UserId' GROUP BY LeadsId ORDER by LeadsId DESC", true);
                                    } elseif (isset($_GET['sub_status'])) {
                                       $sub_status = $_GET['sub_status'];
                                       $GetLeads = FETCH_DB_TABLE("SELECT * FROM leads where LeadPersonSubStatus like '%$sub_status%' and LeadPersonManagedBy='$LOGIN_UserId' GROUP BY LeadsId ORDER by LeadsId DESC", true);
                                    } else {
                                       $GetLeads = FETCH_DB_TABLE("SELECT * FROM leads where LeadPersonManagedBy='$LOGIN_UserId' GROUP BY LeadsId ORDER by LeadsId DESC", true);
                                    }
                                    if ($GetLeads == null) { ?>
                                       <div class="col-md-12">
                                                ...
                                                <p class="data-list flex-s-b">
                                                   ...
                                                   <span class="mt-2px">
                                                      ...
                                                      <span class='right-btn-i text-grey'>
                                                         <?php echo DATE_FORMATE("d M, Y", $leads->LeadPersonCreatedAt); ?>
