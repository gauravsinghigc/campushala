                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <?php
                      $AllDocuments = FETCH_DB_TABLE("SELECT * FROM customer_documents where CustomerDocmentType like '%REGISTER_$ViewBookingId%' and CustomerMainId='" . FETCH($BookingSql, "BookingMainCustomerId") . "'", true);
                      ...
                      ?>
                        <table class='table table-striped'>
                          ...
                          <tr>
                            ...
                            <td><?php echo DATE_FORMATE("d M, Y", FETCH($RefundSql, "BookingRefundApproxClearingDate")); ?></td>
                          </tr>
                          <tr>
                            <th>Refunded By</th>
                        ...
                        <?php
                        $AllRefDocuments = FETCH_DB_TABLE("SELECT * FROM booking_refund_documents where BookingRefundMainId='" . FETCH($RefundSql, "BookingRefundId") . "'", true);
