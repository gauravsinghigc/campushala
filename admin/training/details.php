                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      ...
                      $FetchData = FETCH_DB_TABLE("SELECT * FROM company_policies, company_policy_applicable_on where company_policies.PolicyId=company_policy_applicable_on.PolicyMainId and ApplicableGroupName='" . LOGIN_UserType . "' and company_policies.PolicyId='$id' ORDER BY date('PolicyActiveFrom') DESC", true);
                      if ($FetchData != null) {
                        $SerialNo = 0;
                      ...
                      ?>
                          <div class='col-md-12 col-sm-12 col-12 mb-2'>
                            ...
                            <p class='small'>Active From : <?php echo DATE_FORMATE("d M, Y", $Req->PolicyActiveFrom); ?></p>
                            <br>
