                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_pips where UserPIPMainUserId='" . LOGIN_UserId . "'"); ?></h1>
                        <p class="text-gray">All PIPS</p>
                      </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_pips where UserPIPMainUserId='" . LOGIN_UserId . "' and DATE(UserPIPCreatedAt)='" . date('Y-m-d') . "'"); ?></h1>
                        <p class="text-gray">Today Sent PIPs</p>
                      </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_pips where UserPIPMainUserId='" . LOGIN_UserId . "' and YEAR(UserPIPCreatedAt)='" . date('Y') . "' and MONTH(UserPIPCreatedAt)='" . date('m') . "'"); ?></h1>
                        <p class="text-gray">Current Month PIPs</p>
                      </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-6">
                      <div class="card p-2">
                        <h1><?php echo TOTAL("SELECT * FROM user_pips where UserPIPMainUserId='" . LOGIN_UserId . "' and YEAR(UserPIPCreatedAt)='" . date('Y') . "'"); ?></h1>
                  ...
                  <div class="row">
                    ...
                    if (isset($_GET['UserPIPSubjectName'])) {
                      $AllRewards = FETCH_DB_TABLE("SELECT * FROM user_pips where UserPIPMainUserId='" . LOGIN_UserId . "' and UserPIPSubjectName like '%" . $_GET['UserPIPSubjectName'] . "%' ORDER by DATE(UserPIPCreatedAt) DESC", true);
                    } else {
                      $AllRewards = FETCH_DB_TABLE("SELECT * FROM user_pips where UserPIPMainUserId='" . LOGIN_UserId . "' ORDER by DATE(UserPIPCreatedAt) DESC limit $start, $end", true);
                    }
                    if ($AllRewards == null) {
                    ...
                    <?php
                        include $Dir . "/include/sections/View-PIP-Details.php";
                      }
                    }
