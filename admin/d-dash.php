  ...
  <div class="col-md-3 col-6 mb-10px">
    <a href="digital/compaigns">
      <div class="card card-window card-body rounded-3 p-4 shadow-lg">
        ...
        <p class="mb-0 fs-14 text-black">All Digital Compaigns</p>
      </div>
    </a>
  </div>
  ...
  <div class="col-md-3 col-6 mb-10px">
    <a href="digital/news">
      <div class="card card-window card-body rounded-3 p-4 shadow-lg">
        ...
        <p class="mb-0 fs-14 text-black">All Newspaper Compaigns</p>
      </div>
    </a>
  </div>
