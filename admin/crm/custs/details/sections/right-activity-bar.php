<div class="col-md-4 dashboard-record">
  <div class="card card-body p-2">
    ...
    <div class="data-display-2 height-limit">
      <?php
      $AllAlerts = FETCH_DB_TABLE("SELECT * FROM customer_notifications where CustomerMainId='$ViewCustomerId' order by CustomerNotificationId DESC", true);
      if ($AllAlerts != null) {
      ...
      ?>
          <p class="data-list">
            ...
            <span>
              <span class="text-gray">Send Date</span> : <?php echo DATE_FORMATE("d M, Y", $Alert->CustNotificationDate); ?>
            </span><br>
            <span>
  ...
  <div class="card card-body p-2">
    ...
    <div class="data-display-2 height-limit">
      <ul class="calling-list pt-0">
        <?php
        $fetclFollowUps = FETCH_DB_TABLE("SELECT * FROM lead_followups, leads where lead_followups.LeadFollowMainId=leads.LeadsId and LeadPersonPhoneNumber='" . FETCH($CustomerSql, "CustomerPhoneNumber") . "' ORDER BY LeadFollowUpId DESC limit 0, 25", true);
