                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="row">
                        ...
                        ?>
                            <div class="col-md-12">
                              <p class="data-list flex-s-b">
                                ...
                                <span class="w-pr-15">
                                  <?php
                                  echo "<span class='text-primary'><i class='fa fa-user'></i> $AllUsers</span>/<span class='text-success'>$ReadBy</span>"; ?>
                                </span>
                                <span class="w-pr-10">
                        ...
                        <?php
                            include $Dir . "/include/sections/Update-Circular-Details.php";
                          }
                        }
                        ?>
