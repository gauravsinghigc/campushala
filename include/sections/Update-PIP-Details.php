<section class="pop-section hidden" id="update_<?php echo $Reward->UserPipId; ?>">
 <div class="action-window">
  <div class='container'>
   ...
   <form class="row" action="<?php echo CONTROLLER; ?>/PIPController.php" method="POST">
    ...
    <div class="col-md-12">
     <div class="row">
      <div class="col-md-5">
       ...
       <input type="search" name="search" id="search_<?php echo $Reward->UserPipId; ?>" oninput="SearchData('search_<?php echo $Reward->UserPipId; ?>', 'record-data-<?php echo $Reward->UserPipId; ?>')" class='form-control form-control-sm' placeholder="Search Team Member">
       <div class='data-display height-limit'>
        <?php
        $AllUsers = FETCH_DB_TABLE("SELECT UserId, UserFullName, UserPhoneNumber, UserEmailId FROM users where UserStatus='1' and UserId='" . $Reward->UserPIPMainUserId . "' ORDER BY UserFullName ASC", true);
        if ($AllUsers == null) {
      ...
      <div class="col-md-7">
       ...
       <div class="row">
        <div class="form-group col-md-12">
         ...
         <input type="text" required name="UserPIPSubjectName" value='<?php echo $Reward->UserPIPSubjectName; ?>' class="form-control-sm form-control">
        </div>
        <div class="form-group col-md-12">
         <label>Message </label>
    ...
    <div class=" col-md-12 text-right">
     ...
     <button type="submit" name="UpdatePIPs" class="btn btn-sm btn-success"><i class="fa fa-check"></i> Update Details</button>
