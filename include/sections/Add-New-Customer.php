    ...
    <div class='container'>
      ...
      <form class="row" action="<?php echo CONTROLLER; ?>/CustomerController.php" method="POST">
        ...
        <div class='col-md-4 form-group'>
          ...
          <input type="text" name="CustomerRelationName" class="form-control form-control-sm" required="">
        </div>
        <div class='col-md-4 form-group'>
          <label>Customer Phone <?php echo $req; ?> <span id='phonemsg'></span></label>
          <input type="tel" placeholder="without +91" oninput="CheckExistingPhoneNumbers()" id="PhoneNumber" name="CustomerPhoneNumber" class="form-control form-control-sm" required="">
        </div>
        <div class='col-md-5 form-group'>
          <label>Customer Email-ID <?php echo $req; ?> <span id='emailmsg'></span></label>
          <input type="email" oninput="CheckExistingMailId()" id="EmailId" name="CustomerEmailId" class="form-control form-control-sm" required="">
        </div>
        <div class='col-md-3 form-group'>
          <label>Date of Birth <?php echo $req; ?></label>
          <input type="date" value="<?php echo date("Y-m-d"); ?>" name="CustomerBirthdate" class="form-control form-control-sm" required="">
        </div>
        <div class='col-md-12'>
...
<script>
  function CheckExistingPhoneNumbers() {
    ...
    let ExistingPhoneNumbers = [<?php
                                $AllData = FETCH_DB_TABLE("SELECT * FROM customers", true);
                                if ($AllData != null) {
