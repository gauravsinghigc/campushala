<section class="pop-section hidden" id="update_<?php echo $Reward->RewardsId; ?>">
  <div class="action-window">
    <div class='container'>
      ...
      <form class="row" action="<?php echo CONTROLLER; ?>/RewardController.php" enctype="multipart/form-data" method="POST">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-5">
              ...
              <input type="search" name="search" id="search_<?php echo $Reward->RewardsId; ?>" oninput="SearchData('search_<?php echo $Reward->RewardsId; ?>', 'record-data-<?php echo $Reward->RewardsId; ?>')" class='form-control form-control-sm' placeholder="Search Team Member">
              <div class='data-display height-limit'>
                <?php
                $AllUsers = FETCH_DB_TABLE("SELECT UserId, UserFullName, UserPhoneNumber, UserEmailId FROM users where UserStatus='1' and UserId='" . $Reward->RewardMainUserId . "' ORDER BY UserFullName ASC", true);
                if ($AllUsers == null) {
            ...
            <div class="col-md-7">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" required name="RewardName" value='<?php echo $Reward->RewardName; ?>' class="form-control-sm form-control">
                </div>
                <div class="form-group col-md-6">
                  <label>Reward Receive Date</label>
                  <input type="date" value="<?php echo $Reward->RewardReceiveDate; ?>" required name="RewardReceiveDate" class="form-control-sm form-control">
                </div>
                ...
                <div class="col-md-12">
                  <label>Upload Reward Creative <span class="text-secondary">(png, jpeg only)</span></label>
                  <input type='FILE' name='RewardAttachedCreative' accept="image/*" class="form-control form-control-sm">
                </div>
              </div>
            </div>
          </div>
