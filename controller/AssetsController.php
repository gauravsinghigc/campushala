...
if (isset($_POST['SaveAssetsDetails'])) {
 ...
 $DATA = [
  ...
  "AssetsImage" => UPLOAD_FILES("../storage/assets", "null", "Assets_Img_" . $_POST['AssetName'], $_POST['AssetCategory'], "AssetsImage"),
  "AssetsPurchaseReceipts" => UPLOAD_FILES("../storage/assets", "null", "Assets_Receipts_" . $_POST['AssetName'], $_POST['AssetCategory'], "AssetsPurchaseReceipts"),
 ];
