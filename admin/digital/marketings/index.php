                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      $AllData = FETCH_DB_TABLE("SELECT * FROM marketing_collaterals order by date(AllotmentDate) DESC limit $start, $listcounts", true);
                      if ($AllData == null) {
                        ...
                        foreach ($AllData as $data) {
                          ...
                          <p class="data-list flex-s-b">
                            ...
                            <span class="w-pr-10">
                              <span><?php echo DATE_FORMATE("d M, Y", $data->AllotmentDate); ?></span>
                            </span>
