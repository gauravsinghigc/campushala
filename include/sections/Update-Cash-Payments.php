      ...
      <form action="<?php echo CONTROLLER; ?>/PaymentController.php" method="POST">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-3">
            ...
            <input type="number" name="CASH_Amount" value='<?php echo $Payment->RegPayTotalAmount; ?>' class="form-control form-control-sm">
          </div>
          <div class="form-group col-md-3">
            <label>Cash Received By <?php echo $req; ?></label>
            <input type="text" value='<?php echo $Payment->RegPayCashReceivedBy; ?>' name="CASH_ReceivedBy" class="form-control form-control-sm">
          </div>
          <div class="form-group col-md-3">
            <label>Cash Received On <?php echo $req; ?></label>
            <input type="date" name="CASH_ReceiveDate" value="<?php echo $Payment->RegPaymentDate; ?>" class="form-control form-control-sm">
          </div>
        </div>
