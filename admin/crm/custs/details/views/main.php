 <div class="card card-body p-2">
   ...
   <div class="data-display-2 height-limit">
     <ul>
       <?php
        $AllBookings = FETCH_DB_TABLE("SELECT * FROM bookings where BookingMainCustomerId='$ViewCustomerId' ORDER BY bookingId DESC", true);
        if ($AllBookings != null) {
          $SerialNo = 0;
             ...
             <p class="flex-s-b">
               <span class="w-pr-17 text-left">
                 <span class='btn btn-sm m-t-5'>
                   <span class='text-info'><?php echo DATE_FORMATE("d M, Y", $Booking->BookingDate); ?></span>
                 </span>
               </span>
               <span class='w-pr-18'>
