                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <form action="../../../controller/NewsPaperCompaignController.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="col-md-4 form-group">
                            ...
                            <input type="text" value="<?php echo FETCH($CsQL, "NewsPaperName"); ?>" name="NewsPaperName" class="form-control form-control-sm" required="">
                          </div>
                          <div class="col-md-4 form-group">
                          ...
                          <div class="col-md-4 form-group">
                            ...
                            <input type="text" value="<?php echo FETCH($CsQL, "NewPaperEditions"); ?>" list="NewPaperEditions" name="NewPaperEditions" class="form-control form-control-sm" required="">
                            <?php SUGGEST("newspapercompaigns", "NewPaperEditions", "ASC"); ?>
                          </div>
                          <div class="col-md-4 form-group">
                            <label>Ad Size <?php echo $req; ?></label>
                            <input type="text" value="<?php echo FETCH($CsQL, "NewPaperAdSize"); ?>" list="NewPaperAdSize" name="NewPaperAdSize" class="form-control form-control-sm" required="">
                            <?php SUGGEST("newspapercompaigns", "NewPaperAdSize", "ASC"); ?>
                          </div>

                          <div class="col-md-4 form-group">
                            <label>Publication date <?php echo $req; ?></label>
                            <input type="date" value="<?php echo FETCH($CsQL, "PublicationDate"); ?>" name="PublicationDate" class="form-control form-control-sm" required="">
                          </div>

                          <div class="col-md-4 form-group">
                            <label>Publication Cost <?php echo $req; ?></label>
                            <input type="number" value="<?php echo FETCH($CsQL, "PublicationCost"); ?>" min="1" name="PublicationCost" class="form-control form-control-sm" required="">
                          </div>

                          <div class="col-md-4 form-group">
                            <label>Contact Person Name<?php echo $req; ?></label>
                            <input type="text" value="<?php echo FETCH($CsQL, "ContactPersonName"); ?>" name="ContactPersonName" class="form-control form-control-sm" required="">
                          </div>
                          <div class="col-md-4 form-group">
                            <label>Contact Person Phone <?php echo $req; ?></label>
                            <input type="text" value="<?php echo FETCH($CsQL, "ContactPersonPhoneNumber"); ?>" name="ContactPersonPhoneNumber" class="form-control form-control-sm" required="">
                          </div>
                          <div class="col-md-7 form-group">
                            <label>Newspaper link <?php echo $req; ?></label>
                            <input type="text" value="<?php echo FETCH($CsQL, "NewsPaperLink"); ?>" name="NewsPaperLink" class="form-control form-control-sm" required="">
                          </div>
                          ...
                          <div class="col-md-12 form-group">
                            ...
                            <textarea name="PublicationNotes" class="form-control form-control-sm" rows="4"><?PHP echo SECURE(FETCH($CsQL, "PublicationNotes"), "d"); ?></textarea>
                          </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <form class="form m-t-3" action="../../controller/NewsPaperCompaignController.php" method="POST" enctype="multipart/form-data">
