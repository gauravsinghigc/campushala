<section class="pop-section hidden" id="AddAppraisals">
  <div class="action-window">
    <div class='container'>
      ...
      <form class="row" action="<?php echo CONTROLLER; ?>/AppraisalController.php" enctype="multipart/form-data" method="POST">
            ...
            <div class="col-md-7">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" required name="UserAppraisalName" class="form-control-sm form-control">
                </div>
                <div class="form-group col-md-6">
                  <label>Appraisal Receive Date</label>
                  <input type="date" value="<?php echo date('Y-m-d'); ?>" required name="UserAppraisalDate" class="form-control-sm form-control">
                </div>
