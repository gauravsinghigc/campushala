              ...
              <div class="card card-primary">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <form>
                        <input type="search" oninput="SearchData('SearchRegistration', 'registrations-data')" name="search" id="SearchRegistration" class="form-control form-control-sm" placeholder="Search Refunds...">
                      </form>
                    </div>
                  ...
                  <div class="row">
                    ...
                    if (isset($_GET['fromdate'])) {
                      $From = $_GET['fromdate'];
                      $To = $_GET['todate'];
                      $AllData = FETCH_DB_TABLE("SELECT * FROM booking_refunds where DATE(BookingRefundDate)>='$From' and DATE(BookingRefundDate)<='$To' limit $start, $listcounts", true);
                    } else {
                      $AllData = FETCH_DB_TABLE("SELECT * FROM booking_refunds ORDER BY BookingRefundId  DESC limit $start, $listcounts", true);
                    }
                    if ($AllData != null) {
                      $SerialNo = 0;
                      if (isset($_GET['view_page'])) {
                        ...
                        <div class="col-md-12 registrations-data">
                          <p class="data-list flex-s-b">
                            ...
                            <span class='w-pr-15'>
                              ...
                              <span class="bold">
                                <a href="../bookings/details/?bid=<?php echo SECURE($Data->BookingMainId, "e"); ?>" class="text-primary">
                            ...
                            <span class='w-pr-10'>
                              ...
                              <span><?php echo DATE_FORMATE("d M, Y", $Data->BookingRefundDate); ?></span>
                            </span>
                            <span class='w-pr-8'>
