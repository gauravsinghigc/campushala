<section class="pop-section hidden" id="UploadCustomerDocuments">
    <div class="action-window">
        <div class='container'>
            ...
            <form class="row" enctype="multipart/form-data" action="<?php echo CONTROLLER; ?>/CustomerController.php" method="POST">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="CustomerDocmentType" class="form-control-sm form-control">

                        </div>
                        <div class="form-group  col-md-4">
                            <label>Document Name</label>
                            <select name='CustomerDocumentName' class="form-control form-control-sm" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" required name="CustomerDocumentNo" class="form-control-sm form-control">
                        </div>
                        <div class="form-group col-md-12">
                            <label>Select File <span class="text-gray">pdf, png, jpeg, docs, video, audio only</span></label>
                            <input type="FILE" required name="CustomerDocumentAttachement" class="form-control-sm form-control">
                        </div>
                    </div>
                </div>
