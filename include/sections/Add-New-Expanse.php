    ...
    <div class='container'>
      ...
      <form class="row" action="<?php echo CONTROLLER; ?>/ExpanseController.php" enctype="multipart/form-data" method="POST">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text" required name="ExpanseName" class="form-control-sm form-control">
          <?php SUGGEST("expanses", "ExpanseName", "ASC"); ?>
        </div>
        <div class="form-group col-md-3">
          <label>Expanse Category</label>
          <input type="text" required name="ExpanseCategory" list="ExpanseCategory" class="form-control-sm form-control">
          <?php SUGGEST("expanses", "ExpanseCategory", "ASC"); ?>
        </div>
        <div class="form-group col-md-3">
          <label>Expanse Tags</label>
          <input type="text" required name="ExpanseTags" list="ExpanseTags" class="form-control-sm form-control">
          <?php SUGGEST("expanses", "ExpanseTags", "ASC"); ?>
        </div>
        <div class="form-group col-md-3">
          <label>Expanse Amount</label>
          <input type="text" required name="ExpanseAmount" class="form-control-sm form-control">
        </div>
        <div class="form-group col-md-3">
          <label>Expanse Date</label>
          <input type="date" value="<?php echo date('Y-m-d'); ?>" required name="ExpanseDate" class="form-control-sm form-control">
        </div>
        <div class="col-md-6">
