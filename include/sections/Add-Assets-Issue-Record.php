        ...
        <div class="col-md-12">
          <div class="row">
                    ...
                    <p class="mb-2">
                      <span class="fs-17"><?php echo $Asset->AssetName; ?>
                        <i class="pull-right fs-13 text-secondary italic">
                          <?php echo DATE_FORMATE("d M, Y", $Asset->AssetPurchaseDate); ?>
                        </i>
                      </span>
                      <br>
              ...
              <div class="mt-1">
                <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <input type="date" value="<?php echo date('Y-m-d'); ?>" required name="AssetsIssueDate" class="form-control-sm form-control">
                  </div>
                  <div class="form-group col-md-12">
            ...
            <div class="col-md-6">
              ...
              <input type="search" name="search" id="search23" oninput="SearchData('search23', 'record-dataded')" class='form-control form-control-sm' placeholder="Search Team Member">
