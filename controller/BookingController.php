...
if (isset($_POST['SaveBookingRecord'])) {
  ...
  if ($Response == true) {
    ...
    if ($_POST['DOC_name_1'] != "") {
      $booking_documents1 = [
        ...
        "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REGISTERATION_Doc_$BookingId", $_POST['DOC_name_1'], "DOC_file_1"),
    ...
    if ($_POST['DOC_name_2'] != "") {
      $booking_documents2 = [
        ...
        "CustomerDocumentNo" => $BookingId,
        "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REGISTERATION_Doc_$BookingId", $_POST['DOC_name_2'], "DOC_file_2"),
        "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
        "CustomerDocumentUpdatedBy" => LOGIN_UserId
      ];
    ...
    if ($_POST['DOC_name_3'] != "") {
      $booking_documents3 = [
        ...
        "CustomerDocumentNo" => $BookingId,
        "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REGISTERATION_Doc_$BookingId", $_POST['DOC_name_3'], "DOC_file_3"),
        "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
        "CustomerDocumentUpdatedBy" => LOGIN_UserId
      ];
    ...
    if ($_POST['DOC_name_4'] != "") {
      $booking_documents4 = [
        ...
        "CustomerDocumentNo" => $BookingId,
        "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REGISTERATION_Doc_$BookingId", $_POST['DOC_name_4'], "DOC_file_4"),
        "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
        "CustomerDocumentUpdatedBy" => LOGIN_UserId
      ];
  ...
  if ($_POST['BookingStatus'] == "Active") {
    $access_url = ADMIN_URL . "/crm/bookings/create/?bid=$BookingId";
  }

  if ($_POST['BookingStatus'] == "Refund" || $_POST['BookingStatus'] == "Cancellation") {
    $access_url = ADMIN_URL . "/crm/reg/refund.php?bookingid=$bookingId";
  }
  RESPONSE($Response, "Booking is created successfully", "Unable to create bookings at the moment. Please try again");
  ...
  if ($_POST['DOC_name_1'] != "") {
    $refund_docs1 = [
      ...
      "BookingRefundDocFile" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REFUND_Doc_$BookingMainId", $_POST['DOC_name_1'], "DOC_file_1"),
  ...
  if ($_POST['DOC_name_2'] != "") {
    $refund_docs2 = [
      ...
      "BookingRefundDocFile" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REFUND_Doc_$BookingMainId", $_POST['DOC_name_2'], "DOC_file_2"),
      "BookingRefundDocUploadedAt" => CURRENT_DATE_TIME,
    ];
  ...
  if ($_POST['DOC_name_3'] != "") {
    $refund_docs3 = [
      ...
      "BookingRefundDocFile" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REFUND_Doc_$BookingMainId", $_POST['DOC_name_3'], "DOC_file_3"),
      "BookingRefundDocUploadedAt" => CURRENT_DATE_TIME,
    ];
  ...
  if ($_POST['DOC_name_4'] != "") {
    $refund_docs4 = [
      ...
      "BookingRefundDocFile" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REFUND_Doc_$BookingMainId", $_POST['DOC_name_4'], "DOC_file_4"),
      "BookingRefundDocUploadedAt" => CURRENT_DATE_TIME,
    ];
  ...
  if ($_POST['DOC_name_5'] != "") {
    $refund_docs5 = [
      ...
      "BookingRefundDocFile" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REFUND_Doc_$BookingMainId", $_POST['DOC_name_5'], "DOC_file_5"),
      "BookingRefundDocUploadedAt" => CURRENT_DATE_TIME,
    ];
  ...
  if ($_POST['DOC_name_6'] != "") {
    $refund_docs6 = [
      ...
      "BookingRefundDocFile" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REFUND_Doc_$BookingMainId", $_POST['DOC_name_6'], "DOC_file_6"),
      "BookingRefundDocUploadedAt" => CURRENT_DATE_TIME,
    ];
  ...
  $booking_documents4 = [
    ...
    "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REGISTERATION_Doc_$BookingMainId", $_POST['DOC_name_1'], "DOC_file_1"),
    "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
    "CustomerDocumentUpdatedBy" => LOGIN_UserId
  ];
  $Response = INSERT("customer_documents", $booking_documents4);
  ...
  if ($Response == true) {
    ...
    if ($_POST['DOC_name_1'] != "") {
      $booking_documents1 = [
        ...
        "CustomerDocumentName" => $_POST['DOC_name_1'],
        "CustomerDocumentNo" => $BookingId,
        "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REGISTRATION_Doc_$BookingMainId", $_POST['DOC_name_1'], "DOC_file_1"),
        "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
        "CustomerDocumentUpdatedBy" => LOGIN_UserId
      ];
      $Response = INSERT("customer_documents", $booking_documents1);
    ...
    if ($_POST['DOC_name_2'] != "") {
      $booking_documents2 = [
        ...
        "CustomerDocumentName" => $_POST['DOC_name_2'],
        "CustomerDocumentNo" => $BookingId,
        "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REGISTRATION_Doc_$BookingMainId", $_POST['DOC_name_2'], "DOC_file_2"),
        "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
        "CustomerDocumentUpdatedBy" => LOGIN_UserId
      ];
      $Response = INSERT("customer_documents", $booking_documents2);
    ...
    if ($_POST['DOC_name_3'] != "") {
      $booking_documents3 = [
        ...
        "CustomerDocumentName" => $_POST['DOC_name_3'],
        "CustomerDocumentNo" => $BookingId,
        "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REGISTRATION_Doc_$BookingMainId", $_POST['DOC_name_3'], "DOC_file_3"),
        "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
        "CustomerDocumentUpdatedBy" => LOGIN_UserId
      ];
      $Response = INSERT("customer_documents", $booking_documents3);
    ...
    if ($_POST['DOC_name_4'] != "") {
      $booking_documents4 = [
        ...
        "CustomerDocumentName" => $_POST['DOC_name_4'],
        "CustomerDocumentNo" => $BookingId,
        "CustomerDocumentAttachement" => UPLOAD_FILES("../storage/customers/$CustomerId/docs", "null", "REGISTRATION_Doc_$BookingMainId", $_POST['DOC_name_4'], "DOC_file_4"),
        "CustomerDocUploadedAt" => CURRENT_DATE_TIME,
        "CustomerDocumentUpdatedBy" => LOGIN_UserId
      ];
      $Response = INSERT("customer_documents", $booking_documents4);
