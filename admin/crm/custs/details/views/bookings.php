 <div class="card card-body p-2">
     ...
     <div class="data-display-2 height-limit">
         <ul>
             <?php
                $AllRegistrations = FETCH_DB_TABLE("SELECT * FROM registrations where RegMainCustomerId='$ViewCustomerId' ORDER BY RegistrationId DESC", true);
                     ...
                     <li class="data-list">
                         <p class="flex-s-b">
                             <span class='w-pr-17 text-left'>
                                 <span class='btn btn-sm text-info m-t-7'><?php echo DATE_FORMATE("d M, Y", $Reg->RegistrationDate); ?></span>
                             </span>
                             <span class='w-pr-10'>
                             ...
                             <span class='w-pr-30'>
                                 ...
                                 <span>
                                     ...
                                     <span class='text-success'>
                                         <span><?php echo $Reg->RegUnitAlloted; ?></span> - <span><?php echo $Reg->RegUnitSizeApplied; ?></span>
                                     </span>
                                 </span>
                             </span>
                             <span class='w-pr-15'>
             ...
             <?php
                        include $Dir . "/include/sections/Update-Registration-Details.php";
                    }
                } else {
