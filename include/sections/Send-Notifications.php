<section class="pop-section hidden" id="SendNotifications">
    <div class="action-window">
        <div class='container'>
            ...
            <form class="row" action="<?php echo CONTROLLER; ?>/SendNotificationsController.php" method="POST">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label>Subject</label>
                            <input type="text" required name="CustNotificationSubject" class="form-control-sm form-control">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Send Date</label>
                            <input type="date" value="<?php echo date('Y-m-d');?>" required name="CustNotificationDate" class="form-control-sm form-control">
                        </div>
