                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      ...
                      <form action="../../../controller/LeadsController.php" method="POST">
                        ...
                        if (isset($_GET['search_leads'])) {
                          $search_leads = $_GET['search_leads'];
                          $GetLeads = FETCH_DB_TABLE("SELECT LeadPriorityLevel, LeadPersonSource, LeadPersonManagedBy, LeadSalutations, LeadPersonFullname, LeadPersonStatus, LeadsId, LeadPersonCreatedBy  FROM leads WHERE LeadPersonFullname like '%$search_leads%' and LeadPersonManagedBy='$From' and LeadPersonSource like '%$LeadPersonSource%' and LeadPriorityLevel like '%$LeadPriorityLevel%' and LeadPersonSubStatus like '%$LeadPersonSubStatus%' and LeadPersonStatus LIKE '%$LeadPersonStatus%' GROUP BY LeadsId ORDER by LeadsId DESC limit $start, $listcounts", true);
                        } else {
                          $GetLeads = FETCH_DB_TABLE("SELECT LeadPriorityLevel, LeadPersonSource, LeadPersonManagedBy, LeadSalutations, LeadPersonFullname, LeadPersonStatus, LeadsId, LeadPersonCreatedBy  FROM leads WHERE LeadPersonManagedBy='$From' and LeadPersonSource like '%$LeadPersonSource%' and LeadPriorityLevel like '%$LeadPriorityLevel%' and LeadPersonSubStatus like '%$LeadPersonSubStatus%' and LeadPersonStatus LIKE '%$LeadPersonStatus%' GROUP BY LeadsId ORDER by LeadsId DESC limit $start, $listcounts", true);
                        }
                        $Count = 0;
                        if (isset($_GET['view_page'])) {
                          if ($view_page == 1) {
                        ...
                        if ($GetLeads == null) {
                          ...
                          echo "<h6 class='mb-2 mt-0 ml-2 bold'>Select leads for move : <b class='text-danger'>Total <b>$CountTotalLeads</b> leads found!</b></h6>
                          <div class='row'>";
