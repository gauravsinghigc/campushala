      ...
      <form action="<?php echo CONTROLLER; ?>/PaymentController.php" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-md-3 form-group">
            ...
            <input type="text" VALUE='<?php echo $Payment->RegPaySourceName; ?>' name="ONLINE_BankName" class="form-control form-control-sm">
          </div>
          <div class="col-md-3 form-group">
          ...
          <div class="col-md-3 form-group">
            ...
            <input type="text" value='<?php echo $Payment->RegPayReferenceNo; ?>' name="ONLINE_TransferRefNo" class="form-control form-control-sm">
          </div>
          <div class="col-md-3 form-group">
          ...
          <div class="col-md-2 form-group">
            ...
            <input type="date" value="<?php echo $Payment->RegPaymentDate; ?>" name="ONLINE_TransferDate" class="form-control form-control-sm">
          </div>
          <div class="form-group col-md-4">
            <label>Received By <?php echo $req; ?></label>
            <input type="text" name="ONLINE_ReceivedBy" value="<?php echo $Payment->RegPaymentReceivedBy; ?>" class="form-control form-control-sm">
          </div>
        </div>
