                  ...
                  <form action="upload-documents.php" method="POST">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                          <?php
                          $AllApplicants = FETCH_DB_TABLE("SELECT * FROM customer_co_details where MainCustomerId='" . $_SESSION['REG_CUSTOMER_ID'] . "' ORDER BY CoCustomerName", true);
                              ...
                              <div class="shadow-sm p-2 rounded mb-2">
                                <div>
                                  <p>
                                    ...
                                    <hr class='mt-1 mb-1'>
                                    <a href="#" onclick="Databar('update_applicants_<?php echo $Data->CustCoId; ?>')" class="btn btn-xs btn-default">Edit Details</a>
                                  </p>
                                </div>
                              </div>
                          <?php
                              include  $Dir . "/include/sections/Update-Co-Applicants.php";
                            }
                          } else {
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                          <?php
                          $AllNominee = FETCH_DB_TABLE("SELECT * FROM customer_nominees where CustomerMainId='" . $_SESSION['REG_CUSTOMER_ID'] . "' ORDER BY CustNomFullName", true);
                          if ($AllNominee != NULL) {
                              ...
                              <div class="p-2 shadow-sm mb-2 rounded">
                                <div>
                                  <p>
                                    ...
                                    <hr class='mt-1 mb-1'>
                                    <a href="#" onclick="Databar('update_nominee_<?php echo $Data->CustNomineeId; ?>')" class="btn btn-xs btn-default">Edit Details</a>
                                  </p>
                                </div>
                              </div>
                          <?php
                              include  $Dir . "/include/sections/Update-Nominee-Details.php";
                            }
                          } else {
                            NoData("No Applicant Found!");
                          } ?>
