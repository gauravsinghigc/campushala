                  ...
                  <form action="../../../controller/CreativeController.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-3 form-group">
                        ...
                        <input type="text" name="CreativeName" class="form-control form-control-sm" required="">
                      </div>
                      <div class="col-md-2 form-group">
                        <label>Created On Date <?php echo $req; ?></label>
                        <input type="date" value="<?php echo date("Y-m-d"); ?>" name="CreatedOn" class="form-control form-control-sm" required="">
                      </div>
                      <div class="col-md-3 form-group">
                        <label>Posted On <?php echo $req; ?></label>
                        <input type="text" value="" list="PostedOn" name="PostedOn" class="form-control form-control-sm" required="">
                        <?php SUGGEST("creatives", "PostedOn", "ASC"); ?>
                      </div>
                      <div class="col-md-3 form-group">
                        <label>Creative Occasion <?php echo $req; ?></label>
                        <input type="text" value="" list="CreativeOccasion" name="CreativeOccasion" class="form-control form-control-sm" required="">
                        <?php SUGGEST("creatives", "CreativeOccasion", "ASC"); ?>
                      </div>
                      <div class="col-md-3 form-group">
                        <label>Execution date <?php echo $req; ?></label>
                        <input type="date" value="<?php echo date('Y-m-d'); ?>" name="ExecutionDate" class="form-control form-control-sm" required="">
                      </div>
                      ...
                      <div class="col-md-12 form-group">
                        ...
                        <textarea name="CreativeNotes" class="form-control form-control-sm" rows="4"></textarea>
                      </div>
                      <div class="col-md-12">
