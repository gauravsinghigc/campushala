                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      if (LOGIN_UserType == "Admin") {
                        ...
                        $AllCustomers = FETCH_DB_TABLE("SELECT * FROM users, user_employment_details where UserEmpGroupName='BH' and user_employment_details.UserEmpReportingMember='$LOGIN_UserId' AND users.UserId=user_employment_details.UserMainUserId ORDER BY UserEmpDetailsId Desc", true);
                      }
                    ...
                    <div class="col-md-4">
                      ...
                      if (LOGIN_UserType == "Admin") {
                        ...
                        $LOGIN_UserId = LOGIN_UserId;
                        $AllCustomers = FETCH_DB_TABLE("SELECT * FROM users, user_employment_details where UserEmpGroupName='TH' and user_employment_details.UserEmpReportingMember='$LOGIN_UserId' AND users.UserId=user_employment_details.UserMainUserId ORDER BY UserEmpDetailsId Desc", true);
                      }
                      if ($AllCustomers != null) {
                        $Sno = 0;
                        foreach ($AllCustomers as $Customers) {
                    ...
                    <div class="col-md-4">
                      ...
                      <?php
                      if (LOGIN_UserType == "Admin") {
                        $AllCustomers = FETCH_DB_TABLE("SELECT * FROM users, user_employment_details where UserEmpGroupName='SM' and users.UserId=user_employment_details.UserMainUserId ORDER BY UserEmpDetailsId Desc", true);
                      } else {
                        $LOGIN_UserId = LOGIN_UserId;
                        $AllCustomers = FETCH_DB_TABLE("SELECT * FROM users, user_employment_details where UserEmpGroupName='SM' and user_employment_details.UserEmpReportingMember='$LOGIN_UserId' AND users.UserId=user_employment_details.UserMainUserId ORDER BY UserEmpDetailsId Desc", true);
                      }
                      if ($AllCustomers != null) {
                        $Sno = 0;
                        foreach ($AllCustomers as $Customers) {
