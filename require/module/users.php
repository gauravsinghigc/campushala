...
{
  $AllUsers = FETCH_DB_TABLE("SELECT UserId, UserFullName, UserPhoneNumber, UserEmailId FROM users where UserId='" . $UserId . "' and UserStatus='1' ORDER BY UserFullName ASC", true);
  if ($AllUsers == null) {
