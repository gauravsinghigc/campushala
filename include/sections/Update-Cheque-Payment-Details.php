      ...
      <form action="<?php echo CONTROLLER; ?>/PaymentController.php" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-md-3 form-group">
            ...
            <input type="text" value="<?php echo $Payment->RegPaySourceName; ?>" name="CHEQUE_BankName" class="form-control form-control-sm">
          </div>
          <div class="col-md-3 form-group">
            <label>IFSC Code <?php echo $req; ?></label>
            <input type="text" value='<?php echo $Payment->RegPaySourceNo; ?>' name="CHEQUE_ISFCCode" class="form-control form-control-sm">
          </div>
          <div class="col-md-3 form-group">
            <label>Cheque/DD No <?php echo $req; ?></label>
            <input type="text" value='<?php echo $Payment->RegPayChequeDDNo; ?>' name="CHEQUE_No" class="form-control form-control-sm">
          </div>
          <div class="col-md-3 form-group">
          ...
          <div class="col-md-2 form-group">
            ...
            <input type="date" value="<?php echo $Payment->RegPaymentDate; ?>" name="CHEQUE_IssueDate" class="form-control form-control-sm">
          </div>
          <div class="form-group col-md-4">
            <label>Issued By <?php echo $req; ?></label>
            <input type="text" name="CHEQUE_IssuedBy" value="<?PHP echo $Payment->RegChequePayIssueBy; ?>" class="form-control form-control-sm">
          </div>
        </div>
