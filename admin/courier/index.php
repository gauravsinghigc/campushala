                    ...
                    <div class="col-md-12">
                      <div class="app-heading">
                        <h4 class="mb-0"><?php echo $PageName; ?>
                          <a href="#" onclick="Databar('AddVisitPopUp')" class="btn btn-sm btn-default pull-right"><i class="fa fa-plus"></i> Add Courier</a>
                        </h4>
                      </div>
                    </div>

                    <?php
                    $AllVisitors = FETCH_DB_TABLE("SELECT * FROM visitors where VisitPersonType like '%courier%' ORDER BY VisitorId DESC", true);
                    if ($AllVisitors != null) {
                      $SerialNo = 0;
