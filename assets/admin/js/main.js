...
/** Hide And Show Students  Permanent Address On Click CheckBox */
function ShowPermanentAddress(gridCheck1) {
  let PermanentAddress = document.getElementById("PermanentAddress");
  let PermanentAddressheader = document.getElementById(
    "PermanentAddressheader"
  );
  PermanentAddress.style.display = gridCheck1.checked ? "none" : "block";
  PermanentAddressheader.style.display = gridCheck1.checked ? "none" : "block";
}
