                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 col-12 text-right">
                                            <a href="add.php" class="btn btn-sm btn-dark m-1">Add Universities</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <?php $AllActiveUniversity = FETCH("SELECT COUNT(university_id) AS TotalActiveUniversity FROM universities_primary_details WHERE university_status='1' ", "TotalActiveUniversity");
                                                            ?>
                                                            <div class="col-xxl-3 col-md-4">
                                                                <div class="card info-card sales-card">
                                                                    <div class="filter"> <a class="icon" href="#" data-bs-toggle="dropdown"><i class="bi bi-three-dots"></i></a>
                                                                    ...
                                                                    <div class="card-body account-card-body">
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center"> <i class='bx bx-building-house' style='color:#61f800'></i></div>
                                                                            <div class="ps-3">
                                                                                <h6><?= $AllActiveUniversity ?></h6> <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <?php $AllInactiveUniversity = FETCH("SELECT COUNT(university_id) AS TotalInactiveUniversity FROM universities_primary_details  WHERE university_status='0'  ", "TotalInactiveUniversity");
                                                            ?>
                                                            <div class="col-xxl-3 col-md-4">
                                                                <div class="card info-card revenue-card">
                                                                    ...
                                                                    <div class="card-body account-card-body">
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center"> <i class='bx bx-building-house' style='color:#f80000'></i></div>
                                                                            <div class="ps-3">
                                                                                <h6><?= $AllInactiveUniversity ?></h6> <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <select class="form-control" id="RegState">
                                                                            <option value="">Student Reg. Status</option>
                                                                            <?php
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu custom-dropdown-menu">
                                                                                <!-- <label for="">Fees Mode</label>
                                                                                <select class="form-control" id="FeeMode">
        ...
        $(document).on("click", ".status-changes-btn", function(e) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    changeUniversityStatusBtn: "submit",
                },
                success: function(response) {
                    if (response == "true") {
                        Swal.fire({
                            ...
                            text: 'University Addmission Status Successfully Changed',
                        }).then(function() {
