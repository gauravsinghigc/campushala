...
if (isset($_POST['updateprofileimage'])) {
 ...
 $UserProfileImage = UPLOAD_FILES("../storage/users/$UserId/img", "null", "Profile_Photo_" . "_UID_" . $UserId, "Profile", "UserProfileImage");
 ...
 if ($CheckifPhone != null) {;
  ...
  $Save = SAVE("users", ["UserFullName", "UserDateOfBirth", "UserSalutation", "UserType", "UserPassword", "UserPhoneNumber", "UserEmailId", "UserCompanyName", "UserWorkFeilds", "UserDepartment", "UserDesignation", "UserNotes", "UserStatus", "UserCreatedAt"]);
 }
 ...
 $PanCard = array(
  ...
  "UserDocumentFile" => UPLOAD_FILES("../storage/teams/documents/$UserId", "null", "PanCard", $_POST['PancardNo'], "PancardFile"),
 );
 ...
 $ADHAAR = array(
  ...
  "UserDocumentFile" => UPLOAD_FILES("../storage/teams/documents/$UserId", "null", "AdhaarCard", $_POST['AdhaarNo'], "AdhaarFile"),
 );
 ...
 <b>Login URL: </b> http://365.navix.in/<br>
 <br>
