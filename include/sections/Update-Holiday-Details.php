<section class="pop-section hidden" id="Update_Holiday_<?php echo $Holiday->ConfigHolidayid; ?>">
  <div class="action-window">
    <div class='container'>
      ...
      <form class="row" action="<?php echo CONTROLLER; ?>/HolidayController.php" method="POST">
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="form-group col-md-5">
              ...
              <input type="text" required name="ConfigHolidayName" value='<?php echo $Holiday->ConfigHolidayName; ?>' class="form-control-sm form-control">
            </div>
            <div class="form-group col-md-2">
              <label>Holiday date</label>
              <input type="date" value="<?php echo $Holiday->ConfigHolidayFromDate; ?>" required name="ConfigHolidayFromDate" class="form-control-sm form-control">
            </div>
            <div class="form-group col-md-3">
              <label>Auto Mail reminder for holiday</label>
              <select class="form-control form-control-sm" name='ConfigHolidayMailStatus' required>
